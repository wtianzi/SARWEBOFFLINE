...
from .models import GPSData,ClueMedia,WaypointsData,GPShistoricalData,DataStorage
...
class DataStorageSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = DataStorage
        fields = ('id', 'taskid', 'subtaskid','deviceid')
