...
urlpatterns = [
    ...
    url(r'^gpsgetimagefromserver$',TaskGenerationView.SendImageToPage,name='gpsgetimagefromserver'),
    ...
    url(r'^gpspathlogupdate$',TaskGenerationView.gpspathlogupdate,name='gpspathlogupdate'),
