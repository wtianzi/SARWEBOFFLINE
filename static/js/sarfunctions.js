function hslToRgb(h, s, l) {
 ...
 function ColorGroupInitialize(){
   ...
   t_colorgroup['path3']=[getRandomInt(255), getRandomInt(255), getRandomInt(255)];
   t_colorgroup['path4']=[getRandomInt(255), getRandomInt(255), getRandomInt(255)];
   t_colorgroup['path5']=[getRandomInt(255), getRandomInt(255), getRandomInt(255)];
   return t_colorgroup;
 }
