...
*/
import{g as e}from"./VertexColor.glsl.js";const v={DIFFUSE:0,NORMAL:1,EMISSION:2,OCCLUSION:3,METALLIC_ROUGHNESS:4,SSAO:6,SHADOW_MAP:7};function o(v,o){o.vvInstancingEnabled&&(o.vvSize||o.vvColor)&&v.attributes.add("instanceFeatureAttribute","vec4"),o.vvSize?(v.vertex.uniforms.add("vvSizeMinSize","vec3"),v.vertex.uniforms.add("vvSizeMaxSize","vec3"),v.vertex.uniforms.add("vvSizeOffset","vec3"),v.vertex.uniforms.add("vvSizeFactor","vec3"),v.vertex.uniforms.add("vvSymbolRotationMatrix","mat3"),v.vertex.uniforms.add("vvSymbolAnchor","vec3"),v.vertex.code.add(e`
    ...
    `),o.vvColor?(v.vertex.constants.add("vvColorNumber","int",8),v.vertex.code.add(e`
