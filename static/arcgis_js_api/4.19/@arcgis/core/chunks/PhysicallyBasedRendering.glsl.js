...
*/
import{a1 as e,g as a}from"./VertexColor.glsl.js";import{P as o}from"./PiUtils.glsl.js";function t(o){o.fragment.include(e),o.fragment.uniforms.add("uShadowMapTex","sampler2D"),o.fragment.uniforms.add("uShadowMapNum","int"),o.fragment.uniforms.add("uShadowMapDistance","vec4"),o.fragment.uniforms.add("uShadowMapMatrix","mat4",4),o.fragment.uniforms.add("uDepthHalfPixelSz","float"),o.fragment.code.add(a`
  ...
  `)}function n(e,o){0===o.output&&o.receiveShadows?(e.varyings.add("linearDepth","float"),e.vertex.code.add(a`
    ...
    `)):1===o.output||3===o.output?(e.varyings.add("linearDepth","float"),e.vertex.uniforms.add("cameraNearFar","vec2"),e.vertex.code.add(a`
