...
/*
 ...
 rights grant found at http://polymer.github.io/PATENTS.txt
  ...
  This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
define("../../../chunks/_rollupPluginBabelHelpers ../../../chunks/tslib.es6 ../../../core/has ../../../core/maybe ../../../core/Logger ../../../core/accessorSupport/decorators/property ../../../core/accessorSupport/decorators/aliasOf ../../../core/accessorSupport/decorators/cast ../../../core/jsonMap ../../../core/accessorSupport/decorators/subclass ../../../core/urlUtils ../../../core/uuid ../../../portal/support/resourceExtension ../../../core/events ../../../core/Collection ../../../core/watchUtils ../../../core/HandleOwner ../../support/widgetUtils ../../support/decorators/messageBundle ../../../chunks/index ../../Widget ./GridViewModel".split(" "),
function(Vd,x,mg,Wd,ng,W,H,Xd,og,Yd,pg,qg,rg,Xb,Zd,db,$d,ae,be,ka,ce,de){function Yb(b){requestAnimationFrame(function(){Zb?Zb(b):(eb||(eb=new Promise(a=>{fb=a}),"complete"===document.readyState?fb():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&fb()})),eb.then(function(){b&&b()}))})}function gb(b,a){for(let c in a)null===c?b.style.removeProperty(c):b.style.setProperty(c,a[c])}function $b(b,a){return(b=window.getComputedStyle(b).getPropertyValue(a))?b.trim():
""}function ac(b){hb=b&&b.shimcssproperties?!1:Ga||!(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)||!window.CSS||!CSS.supports||!CSS.supports("box-shadow","0 0 0 var(--foo)"))}function la(b,a){if(b&&ee.test(b)||"//"===b)return b;if(void 0===Ha){Ha=!1;try{const c=new URL("b","http://a");c.pathname="c%20d";Ha="http://a/c%20d"===c.href}catch(c){}}a||(a=document.baseURI||window.location.href);if(Ha)try{return(new URL(b,a)).href}catch(c){return b}C||(C=document.implementation.createHTMLDocument("temp"),
C.base=C.createElement("base"),C.head.appendChild(C.base),C.anchor=C.createElement("a"),C.body.appendChild(C.anchor));C.base.href=a;C.anchor.href=b;return C.anchor.href||b}function ib(b,a){return b.replace(fe,function(c,d,e,f){return d+"'"+la(e.replace(/["']/g,""),a)+"'"+f})}function jb(b){return b.substring(0,b.lastIndexOf("/")+1)}function bc(b){b=ib((b.body?b.body:b).textContent,b.baseURI);const a=document.createElement("style");a.textContent=b;return a}function ge(b){b=b.trim().split(/\s+/);const a=
[];for(let c=0;c<b.length;c++)a.push(...he(b[c]));return a}function he(b){const a=O.import(b);if(!a)return console.warn("Could not find style data in module named",b),[];if(void 0===a._styles){b=[];b.push(...kb(a));const c=a.querySelector("template");c&&b.push(...lb(c,a.assetpath));a._styles=b}return a._styles}function lb(b,a){if(!b._styles){const c=[],d=b.content.querySelectorAll("style");for(let e=0;e<d.length;e++){let f=d[e],g=f.getAttribute("include");g&&c.push(...ge(g).filter(function(h,k,l){return l.indexOf(h)===
k}));a&&(f.textContent=ib(f.textContent,a));c.push(f)}b._styles=c}return b._styles}function ie(b){return(b=O.import(b))?kb(b):[]}function kb(b){const a=[];b=b.querySelectorAll("link[rel\x3dimport][type~\x3dcss]");for(let d=0;d<b.length;d++){var c=b[d];if(c.import){const e=c.import;if((c=c.hasAttribute("shady-unscoped"))&&!e._unscopedStyle){const f=bc(e);f.setAttribute("shady-unscoped","");e._unscopedStyle=f}else e._style||(e._style=bc(e));a.push(c?e._unscopedStyle:e._style)}}return a}function I(b){let a=
b.indexOf(".");return-1===a?b:b.slice(0,a)}function ma(b){if(Array.isArray(b)){let a=[];for(let c=0;c<b.length;c++){let d=b[c].toString().split(".");for(let e=0;e<d.length;e++)a.push(d[e])}return a.join(".")}return b}function cc(b){return Array.isArray(b)?ma(b).split("."):b.toString().split(".")}function A(b,a,c){a=cc(a);for(let d=0;d<a.length;d++){if(!b)return;b=b[a[d]]}c&&(c.path=a.join("."));return b}function dc(b,a,c){let d=cc(a),e=d[d.length-1];if(1<d.length){for(a=0;a<d.length-1;a++)if(b=b[d[a]],
!b)return;b[e]=c}else b[a]=c;return d.join(".")}function ec(b){return Ia[b]||(Ia[b]=0>b.indexOf("-")?b:b.replace(je,a=>a[1].toUpperCase()))}function Ja(b){return Ia[b]||(Ia[b]=b.replace(ke,"-$1").toLowerCase())}function fc(b,a){let c=a.parentInfo&&fc(b,a.parentInfo);if(c)for(let d=c.firstChild,e=0;d;d=d.nextSibling){if(a.parentIndex===e++)return d}else return b}function le(b,a,c){b=b._methodHost||b;return function(d){if(b[c])b[c](d,d.detail);else console.warn("listener method `"+c+"` not defined")}}
function mb(b,a,c){let d=b[a];if(!d)d=b[a]={};else if(!b.hasOwnProperty(a)&&(d=b[a]=Object.create(b[a]),c))for(let e in d)for(b=d[e],a=d[e]=Array(b.length),c=0;c<b.length;c++)a[c]=b[c];return d}function na(b,a,c,d,e,f){if(a){let h=!1;const k=oa++;for(let l in c){var g=e?I(l):l;if(g=a[g])for(let m=0,n=g.length,p;m<n&&(p=g[m]);m++)p.info&&p.info.lastRun===k||e&&!nb(l,p.trigger)||(p.info&&(p.info.lastRun=k),p.fn(b,l,c,d,p.info,e,f),h=!0)}return h}return!1}function nb(b,a){if(a){let c=a.name;return c==
b||!(!a.structured||0!==c.indexOf(b+"."))||!(!a.wildcard||0!==b.indexOf(c+"."))}return!0}function gc(b,a,c,d,e){a="string"===typeof e.method?b[e.method]:e.method;c=e.property;a?a.call(b,b.__data[c],d[c]):e.dynamicFn||console.warn("observer method `"+e.method+"` not defined")}function hc(b,a,c,d){c={value:c,queueProperty:!0};d&&(c.path=d);q(b).dispatchEvent(new CustomEvent(a,{detail:c}))}function me(b,a,c,d,e,f){f=(d=(f?I(a):a)!=a?a:null)?A(b,d):b.__data[a];d&&void 0===f&&(f=c[a]);hc(b,e.eventName,
f,d)}function ne(b,a,c,d,e){c=b.__data[a];Ka&&(c=Ka(c,e.attrName,"attribute",b));b._propertyToAttribute(a,e.attrName,c)}function oe(b){let a=b.constructor.__orderedComputedDeps;if(!a){a=new Map;const d=b[t.COMPUTE];let {counts:e,ready:f,total:g}=pe(b);for(var c;c=f.shift();)a.set(c,a.size),(c=d[c])&&c.forEach(h=>{h=h.info.methodInfo;--g;0===--e[h]&&f.push(h)});0!==g&&console.warn(`Computed graph for ${b.localName} incomplete; circular?`);b.constructor.__orderedComputedDeps=a}return a}function pe(b){const a=
b.__computeInfo,c={};b=b[t.COMPUTE];const d=[];let e=0;for(let f in a){const g=a[f];e+=c[f]=g.args.filter(h=>!h.literal).length+(g.dynamicFn?1:0)}for(let f in b)a[f]||d.push(f);return{counts:c,ready:d,total:e}}function ic(b,a,c,d,e){a=ob(b,a,c,d,e);if(a===pa)return!1;e=e.methodInfo;if(b.__dataHasAccessor&&b.__dataHasAccessor[e])return b._setPendingProperty(e,a,!0);b[e]=a;return!1}function pb(b,a,c,d,e,f,g){c.bindings=c.bindings||[];d={kind:d,target:e,parts:f,literal:g,isCompound:1!==f.length};c.bindings.push(d);
if(d.target&&"attribute"!=d.kind&&"text"!=d.kind&&!d.isCompound&&"{"===d.parts[0].mode){let {event:n,negate:p}=d.parts[0];d.listenerEvent=n||Ja(e)+"-changed";d.listenerNegate=p}c=a.nodeInfoList.length;for(g=0;g<d.parts.length;g++){var h=d.parts[g];h.compoundIndex=g;e=b;f=a;var k=d,l=h,m=c;if(!l.literal)if("attribute"===k.kind&&"-"===k.target[0])console.warn("Cannot set attribute "+k.target+' because "-" is not a valid attribute starting character');else for(h=l.dependencies,k={index:m,binding:k,part:l,
evaluator:e},l=0;l<h.length;l++)m=h[l],"string"==typeof m&&(m=jc(m),m.wildcard=!0),e._addTemplatePropertyEffect(f,m.rootProperty,{fn:qe,info:k,trigger:m})}}function qe(b,a,c,d,e,f,g){g=g[e.index];var h=e.binding;let k=e.part;f&&k.source&&a.length>k.source.length&&"property"==h.kind&&!h.isCompound&&g.__isPropertyEffectsClient&&g.__dataHasAccessor&&g.__dataHasAccessor[h.target]?(c=c[a],a=h.target+a.slice(k.source.length),g._setPendingPropertyOrPath(a,c,!1,!0)&&b._enqueueClient(g)):(a=e.evaluator._evaluateBinding(b,
k,a,c,d,f),a!==pa&&(h.isCompound&&(c=g.__dataCompoundStorage[h.target],c[k.compoundIndex]=a,a=c.join("")),"attribute"===h.kind||"textContent"!==h.target&&("value"!==h.target||"input"!==g.localName&&"textarea"!==g.localName)||(a=void 0==a?"":a),Ka&&(a=Ka(a,h.target,h.kind,g)),"attribute"==h.kind?b._valueToNodeAttribute(g,a,h.target):(h=h.target,g.__isPropertyEffectsClient&&g.__dataHasAccessor&&g.__dataHasAccessor[h]?g[t.READ_ONLY]&&g[t.READ_ONLY][h]||g._setPendingProperty(h,a)&&b._enqueueClient(g):
b._setUnmanagedPropertyToNode(g,h,a))))}function re(b,a,c){if(c.listenerEvent){let d=c.parts[0];b.addEventListener(c.listenerEvent,function(e){{var f=c.target,g=d.source,h=d.negate;let k=e.detail,l=k&&k.path;l?(g+=l.slice(f.length),e=k&&k.value):e=e.currentTarget[f];a[t.READ_ONLY]&&a[t.READ_ONLY][g]||!a._setPendingPropertyOrPath(g,h?!e:e,!0,!!l)||k&&k.queueProperty||a._invalidateProperties()}})}}function kc(b,a,c,d,e,f){f=a.static||f&&("object"!==typeof f||f[a.methodName]);e={methodName:a.methodName,
args:a.args,methodInfo:e,dynamicFn:f};for(let g=0,h;g<a.args.length&&(h=a.args[g]);g++)h.literal||b._addPropertyEffect(h.rootProperty,c,{fn:d,info:e,trigger:h});f&&b._addPropertyEffect(a.methodName,c,{fn:d,info:e});return e}function ob(b,a,c,d,e){d=b._methodHost||b;let f=d[e.methodName];if(f)return b=b._marshalArgs(e.args,a,c),b===pa?pa:f.apply(d,b);e.dynamicFn||console.warn("method `"+e.methodName+"` not defined")}function lc(b){let a="";for(let c=0;c<b.length;c++)a+=b[c].literal||"";return a}function qb(b){var a=
b.match(/([^\s]+?)\(([\s\S]*)\)/);return a?(b={methodName:a[1],static:!0,args:se},a[2].trim()?(a=a[2].replace(/\\,/g,"\x26comma;").split(","),te(a,b)):b):null}function te(b,a){a.args=b.map(function(c){c=jc(c);c.literal||(a.static=!1);return c},this);return a}function jc(b){b=b.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1");let a={name:b,value:"",literal:!1},c=b[0];"-"===c&&(c=b[1]);"0"<=c&&"9">=c&&(c="#");switch(c){case "'":case '"':a.value=b.slice(1,-1);a.literal=!0;break;case "#":a.value=
Number(b),a.literal=!0}a.literal||(a.rootProperty=I(b),a.structured=0<=b.indexOf("."),a.structured&&(a.wildcard=".*"==b.slice(-2),a.wildcard&&(a.name=b.slice(0,-2))));return a}function mc(b,a,c){b=A(b,c);void 0===b&&(b=a[c]);return b}function nc(b,a,c,d){d={indexSplices:d};rb&&!b._overrideLegacyUndefined&&(a.splices=d);b.notifyPath(c+".splices",d);b.notifyPath(c+".length",a.length);rb&&!b._overrideLegacyUndefined&&(d.indexSplices=[])}function qa(b,a,c,d,e,f){nc(b,a,c,[{index:d,addedCount:e,removed:f,
object:a,type:"splice"}])}function ue(b){return b[0].toUpperCase()+b.substring(1)}function oc(b){if(!(-1<La.indexOf(b))&&"touchend"!==b&&sb&&tb&&ve)return{passive:!0}}function pc(b){let a=qc?["click"]:La;for(let c=0,d;c<a.length;c++)d=a[c],b?(ub.length=0,document.addEventListener(d,rc,!0)):document.removeEventListener(d,rc,!0)}function X(b){var a=b.type;return-1<La.indexOf(a)?"mousemove"===a?(a=void 0===b.buttons?1:b.buttons,b instanceof window.MouseEvent&&!we&&(a=xe[b.which]||0),!!(a&1)):0===(void 0===
b.button?0:b.button):!1}function ye(b){if("click"===b.type){if(0===b.detail)return!0;var a=P(b);if(!a.nodeType||a.nodeType!==Node.ELEMENT_NODE)return!0;a=a.getBoundingClientRect();let c=b.pageX;b=b.pageY;return!(c>=a.left&&c<=a.right&&b>=a.top&&b<=a.bottom)}return!1}function sc(b,a,c){b.movefn=a;b.upfn=c;document.addEventListener("mousemove",a);document.addEventListener("mouseup",c)}function aa(b){document.removeEventListener("mousemove",b.movefn);document.removeEventListener("mouseup",b.upfn);b.movefn=
null;b.upfn=null}function P(b){const a=Ma(b);return 0<a.length?a[0]:b.target}function tc(b){let a=b.type;var c=b.currentTarget.__polymerGestures;if(c&&(c=c[a])){if(!b.__polymerGesturesHandled&&(b.__polymerGesturesHandled={},"touch"===a.slice(0,5))){var d=b.changedTouches[0];"touchstart"===a&&1===b.touches.length&&(y.touch.id=d.identifier);if(y.touch.id!==d.identifier)return;if(!sb&&("touchstart"===a||"touchmove"===a)){d=b.changedTouches[0];var e=b.type;if("touchstart"===e)y.touch.x=d.clientX,y.touch.y=
d.clientY,y.touch.scrollDecided=!1;else if("touchmove"===e&&!y.touch.scrollDecided){y.touch.scrollDecided=!0;e="auto";var f=Ma(b);for(let h=0,k;h<f.length;h++)if(k=f[h],k.__polymerGesturesTouchAction){e=k.__polymerGesturesTouchAction;break}f=!1;var g=Math.abs(y.touch.x-d.clientX);d=Math.abs(y.touch.y-d.clientY);b.cancelable&&("none"===e?f=!0:"pan-x"===e?f=d>g:"pan-y"===e&&(f=g>d));f?b.preventDefault():Na("track")}}}d=b.__polymerGesturesHandled;if(!d.skip){for(let h=0,k;h<Y.length;h++)k=Y[h],c[k.name]&&
!d[k.name]&&k.flow&&-1<k.flow.start.indexOf(b.type)&&k.reset&&k.reset();for(let h=0,k;h<Y.length;h++)k=Y[h],c[k.name]&&!d[k.name]&&(d[k.name]=!0,k[a](b))}}}function vb(b,a,c){if(ra[a]){{let d=ra[a],e=d.deps,f=d.name,g=b.__polymerGestures;g||(b.__polymerGestures=g={});for(let h=0,k,l;h<e.length;h++)k=e[h],qc&&-1<La.indexOf(k)&&"click"!==k||((l=g[k])||(g[k]=l={_count:0}),0===l._count&&b.addEventListener(k,tc,oc(k)),l[f]=(l[f]||0)+1,l._count=(l._count||0)+1);b.addEventListener(a,c);d.touchAction&&uc(b,
d.touchAction)}return!0}return!1}function wb(b){Y.push(b);for(let a=0;a<b.emits.length;a++)ra[b.emits[a]]=b}function uc(b,a){sb&&b instanceof HTMLElement&&F.run(()=>{b.style.touchAction=a});b.__polymerGesturesTouchAction=a}function xb(b,a,c){a=new Event(a,{bubbles:!0,cancelable:!0,composed:!0});a.detail=c;q(b).dispatchEvent(a);a.defaultPrevented&&(b=c.preventer||c.sourceEvent)&&b.preventDefault&&b.preventDefault()}function Na(b){a:{for(let a=0,c;a<Y.length;a++){c=Y[a];for(let d=0,e;d<c.emits.length;d++)if(e=
c.emits[d],e===b){b=c;break a}}b=null}b.info&&(b.info.prevent=!0)}function sa(b,a,c,d){a&&xb(a,b,{x:c.clientX,y:c.clientY,sourceEvent:c,preventer:d,prevent:function(e){return Na(e)}})}function vc(b,a,c){if(b.prevent)return!1;if(b.started)return!0;c=Math.abs(b.y-c);return 5<=Math.abs(b.x-a)||5<=c}function yb(b,a,c){if(a){var d=b.moves[b.moves.length-2],e=b.moves[b.moves.length-1],f=e.x-b.x,g=e.y-b.y,h=0;if(d){var k=e.x-d.x;h=e.y-d.y}xb(a,"track",{state:b.state,x:c.clientX,y:c.clientY,dx:f,dy:g,ddx:k,
ddy:h,sourceEvent:c,hover:function(){{var l=c.clientX;var m=c.clientY;let n=document.elementFromPoint(l,m),p=n;for(;p&&p.shadowRoot&&!window.ShadyDOM;){let r=p;p=p.shadowRoot.elementFromPoint(l,m);if(r===p)break;p&&(n=p)}l=n}return l}})}}function wc(b,a,c){let d=Math.abs(a.clientX-b.x),e=Math.abs(a.clientY-b.y),f=P(c||a);!f||ze[f.localName]&&f.hasAttribute("disabled")||!(isNaN(d)||isNaN(e)||25>=d&&25>=e||ye(a))||b.prevent||xb(f,"tap",{x:a.clientX,y:a.clientY,sourceEvent:a,preventer:c})}function Ae(){return xc(function(){return!0})}
function Be(){return Oa&&0<Object.keys(Oa).map(b=>Oa[b]).filter(b=>b.productionMode).length?!0:!1}function xc(b,a){if("function"===typeof b){var c=Ce.exec(b.toString());if(c)try{b=new Function(c[1])}catch(d){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",d)}return b(a)}}function De(){}function yc(b){b=b.replace(J.comments,"").replace(J.port,"");{var a=b;let c=new zc;c.start=0;c.end=a.length;let d=c;for(let e=0,f=a.length;e<f;e++)if("{"===a[e]){d.rules||(d.rules=[]);let g=
d,h=g.rules[g.rules.length-1]||null;d=new zc;d.start=e+1;d.parent=g;d.previous=h;g.rules.push(d)}else"}"===a[e]&&(d.end=e+1,d=d.parent||c);a=c}return Ac(a,b)}function Ac(b,a){var c=a.substring(b.start,b.end-1);b.parsedCssText=b.cssText=c.trim();b.parent&&(c=a.substring(b.previous?b.previous.end:b.parent.start,b.start-1),c=Ee(c),c=c.replace(J.multipleSpaces," "),c=c.substring(c.lastIndexOf(";")+1),c=b.parsedSelector=b.selector=c.trim(),b.atRule=0===c.indexOf("@"),b.atRule?0===c.indexOf("@media")?b.type=
Q.MEDIA_RULE:c.match(J.keyframesRule)&&(b.type=Q.KEYFRAMES_RULE,b.keyframesName=b.selector.split(J.multipleSpaces).pop()):0===c.indexOf("--")?b.type=Q.MIXIN_RULE:b.type=Q.STYLE_RULE);if(c=b.rules)for(let d=0,e=c.length,f;d<e&&(f=c[d]);d++)Ac(f,a);return b}function Ee(b){return b.replace(/\\([0-9a-f]{1,6})\s/gi,function(a,c){a=c;for(c=6-a.length;c--;)a="0"+a;return"\\"+a})}function Bc(b,a,c=""){let d="";if(b.cssText||b.rules){let f=b.rules;var e;if(e=f)e=f[0],e=!!e&&!!e.selector&&0===e.selector.indexOf("--"),
e=!e;if(e)for(let g=0,h=f.length,k;g<h&&(k=f[g]);g++)d=Bc(k,a,d);else a?a=b.cssText:(a=b.cssText,a=a.replace(J.customProp,"").replace(J.mixinProp,""),a=a.replace(J.mixinApply,"").replace(J.varApply,"")),(d=a.trim())&&(d="  "+d+"\n")}d&&(b.selector&&(c+=b.selector+" {\n"),c+=d,b.selector&&(c+="}\n\n"));return c}function zb(b,a){if(!b)return"";"string"===typeof b&&(b=yc(b));a&&ta(b,a);return Bc(b,Ab)}function Cc(b){!b.__cssRules&&b.textContent&&(b.__cssRules=yc(b.textContent));return b.__cssRules||
null}function ta(b,a,c,d){if(b){var e=!1,f=b.type;if(d&&f===Q.MEDIA_RULE){let g=b.selector.match(Fe);g&&(window.matchMedia(g[1]).matches||(e=!0))}f===Q.STYLE_RULE?a(b):c&&f===Q.KEYFRAMES_RULE?c(b):f===Q.MIXIN_RULE&&(e=!0);if((b=b.rules)&&!e)for(let g=0,h=b.length,k;g<h&&(k=b[g]);g++)ta(k,a,c,d)}}function Dc(b,a){var c=b.indexOf("var(");if(-1===c)return a(b,"","","");a:{var d=0;for(let g=c+3,h=b.length;g<h;g++)if("("===b[g])d++;else if(")"===b[g]&&0===--d){d=g;break a}d=-1}var e=d;d=b.substring(c+
4,e);c=b.substring(0,c);b=Dc(b.substring(e+1),a);let f=d.indexOf(",");if(-1===f)return a(c,d.trim(),"",b);e=d.substring(0,f).trim();d=d.substring(f+1).trim();return a(c,e,d,b)}function Ec(b){if(void 0!==ua)return ua;if(void 0===b.__cssBuild){var a=b.getAttribute("css-build");if(a)b.__cssBuild=a;else{a:{a="template"===b.localName?b.content.firstChild:b.firstChild;if(a instanceof Comment&&(a=a.textContent.trim().split(":"),"css-build"===a[0])){a=a[1];break a}a=""}if(""!==a){{const c="template"===b.localName?
b.content.firstChild:b.firstChild;c.parentNode.removeChild(c)}}b.__cssBuild=a}}return b.__cssBuild||""}function Ge(b){if(b=Bb[b])b._applyShimCurrentVersion=b._applyShimCurrentVersion||0,b._applyShimValidatingVersion=b._applyShimValidatingVersion||0,b._applyShimNextVersion=(b._applyShimNextVersion||0)+1}function Fc(b){return b._applyShimCurrentVersion===b._applyShimNextVersion}function He(b){b._applyShimValidatingVersion=b._applyShimNextVersion;b._validating||(b._validating=!0,Ie.then(function(){b._applyShimCurrentVersion=
b._applyShimNextVersion;b._validating=!1}))}function Gc(){va=document.documentElement.getAttribute("dir");va=document.documentElement.getAttribute("dir");for(let a=0;a<wa.length;a++){var b=wa[a];b.__autoDirOptOut||b.setAttribute("dir",va)}}function Hc(){Pa=!0;requestAnimationFrame(function(){Pa=!1;Je(Ic);setTimeout(function(){var b=Jc;for(let a=0,c=b.length;a<c;a++)Kc(b.shift())})})}function Je(b){for(;b.length;)Kc(b.shift())}function Kc(b){const a=b[0],c=b[1];b=b[2];try{c.apply(a,b)}catch(d){setTimeout(()=>
{throw d;})}}function Ke(b,a,c){Pa||Hc();Ic.push([b,a,c])}function Le(b,a,c){Pa||Hc();Jc.push([b,a,c])}function Lc(){document.body.removeAttribute("unresolved")}function xa(b,a,c){return{index:b,removed:a,addedCount:c}}function Mc(b,a,c,d,e,f){var g=0,h=0,k=Math.min(c-a,f-e);if(0==a&&0==e)a:{for(g=0;g<k;g++)if(b[g]!==d[g])break a;g=k}if(c==b.length&&f==d.length){h=k-g;k=b.length;for(var l=d.length,m=0;m<h&&Me(b[--k],d[--l]);)m++;h=m}a+=g;e+=g;c-=h;f-=h;if(0==c-a&&0==f-e)return[];if(a==c){for(b=xa(a,
...
g=k),c--,f--):n==l?(h.push(3),c--,g=l):(h.push(2),f--,g=m));h.reverse();c=h;b=void 0;f=[];for(g=0;g<c.length;g++)switch(c[g]){case 0:b&&(f.push(b),b=void 0);a++;e++;break;case 1:b||(b=xa(a,[],0));b.addedCount++;a++;b.removed.push(d[e]);e++;break;case 2:b||(b=xa(a,[],0));b.addedCount++;a++;break;case 3:b||(b=xa(a,[],0)),b.removed.push(d[e]),e++}b&&f.push(b);return f}function Me(b,a){return b===a}function ba(b){return"slot"===b.localName}function Ne(b,a){for(let c=0;c<a.length;c++){let d=a[c];b[d]=
function(){return this.node[d].apply(this.node,arguments)}}}function Nc(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},configurable:!0})}}function Oe(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},set:function(e){this.node[d]=e},configurable:!0})}}function Pe(b,a=!1){if(!Cb||!Oc||!Cb.handlesDynamicScoping)return null;const c=Oc.ScopingShim;if(!c)return null;const d=c.scopeForNode(b),
...
a):null}function Pc(b,a,c,d){{const e=a._noAccessors,f=Object.getOwnPropertyNames(a);for(let g=0;g<f.length;g++){let h=f[g];if(!(h in d))if(e)b[h]=a[h];else{let k=Object.getOwnPropertyDescriptor(a,h);k&&(k.configurable=!0,Object.defineProperty(b,h,k))}}}for(let e in Qe)a[e]&&(c[e]=c[e]||[],c[e].push(a[e]))}function Qc(b,a,c){a=a||[];for(let d=b.length-1;0<=d;d--){let e=b[d];e?Array.isArray(e)?Qc(e,a):0>a.indexOf(e)&&(!c||0>c.indexOf(e))&&a.unshift(e):console.warn("behavior is null, check for missing or 404 import")}return a}
function Rc(b,a){for(const c in a){const d=b[c],e=a[c];b[c]=!("value"in e)&&d&&"value"in d?Object.assign({value:d.value},e):e}}function Re(b,a,c){let d;const e={};class f extends a{static _finalizeClass(){if(this.hasOwnProperty("generatedFrom")){if(d)for(let h=0,k;h<d.length;h++)k=d[h],k.properties&&this.createProperties(k.properties),k.observers&&this.createObservers(k.observers,k.properties);b.properties&&this.createProperties(b.properties);b.observers&&this.createObservers(b.observers,b.properties);
this._prepareTemplate()}else a._finalizeClass.call(this)}static get properties(){const h={};if(d)for(let k=0;k<d.length;k++)Rc(h,d[k].properties);Rc(h,b.properties);return h}static get observers(){let h=[];if(d)for(let k=0,l;k<d.length;k++)l=d[k],l.observers&&(h=h.concat(l.observers));b.observers&&(h=h.concat(b.observers));return h}created(){super.created();const h=e.created;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}_registered(){var h=f.prototype;if(!h.hasOwnProperty("__hasRegisterFinished")){h.__hasRegisterFinished=
...
let h=e.ready;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}attached(){super.attached();let h=e.attached;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}detached(){super.detached();let h=e.detached;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}attributeChanged(h,k,l){super.attributeChanged();let m=e.attributeChanged;if(m)for(let n=0;n<m.length;n++)m[n].call(this,h,k,l)}}if(c){Array.isArray(c)||(c=[c]);let h=a.prototype.behaviors;d=Qc(c,null,h);f.prototype.behaviors=h?h.concat(c):d}const g=h=>
{if(d){var k=d;for(let l=0;l<k.length;l++)Pc(h,k[l],e,Se)}Pc(h,b,e,Sc)};ya||g(f.prototype);f.generatedFrom=b;return f}function Db(b,a,c,d,e){let f;e&&(f="object"===typeof c&&null!==c)&&(d=b.__dataTemp[a]);d=d!==c&&(d===d||c===c);f&&d&&(b.__dataTemp[a]=c);return d}function Eb(){return Fb}function Tc(b,a){for(let c=0;c<a.length;c++){let d=a[c];if(!!b!=!!d.__hideTemplateChildren__)if(d.nodeType===Node.TEXT_NODE)b?(d.__polymerTextContent__=d.textContent,d.textContent=""):d.textContent=d.__polymerTextContent__;
else if("slot"===d.localName)if(b)d.__polymerReplaced__=document.createComment("hidden-slot"),q(q(d).parentNode).replaceChild(d.__polymerReplaced__,d);else{const e=d.__polymerReplaced__;e&&q(q(e).parentNode).replaceChild(d,e)}else d.style&&(b?(d.__polymerDisplay__=d.style.display,d.style.display="none"):d.style.display=d.__polymerDisplay__);d.__hideTemplateChildren__=b;d._showHideChildren&&d._showHideChildren(b)}}function Uc(b){return(b=b.__dataHost)&&b._methodHost||b}function Te(b,a){return function(c,
d,e){a.call(c.__templatizeOwner,d.substring(6),e[d])}}function Ue(b,a){return function(c,d,e){a.call(c.__templatizeOwner,c,d,e[d])}}function Ve(){return function(b,a,c){b.__dataHost._setPendingPropertyOrPath("_host_"+a,c[a],!0,!0)}}function za(b,a,c){if(ca&&!Uc(b))throw Error("strictTemplatePolicy: template owner not trusted");c=c||{};if(b.__templatizeOwner)throw Error("A \x3ctemplate\x3e can only be templatized once");b.__templatizeOwner=a;let d=(a?a.constructor:Gb)._parseTemplate(b);var e=d.templatizeInstanceClass;
if(!e){e=c;var f=e.mutableData?We:Gb;za.mixin&&(f=za.mixin(f));var g=class extends f{};g.prototype.__templatizeOptions=e;g.prototype._bindTemplate(b);f=g;var h=d.hostProps||{};for(var k in e.instanceProps){delete h[k];var l=e.notifyInstanceProp;l&&f.prototype._addPropertyEffect(k,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Ue(k,l)})}if(e.forwardHostProp&&b.__dataHost)for(var m in h)d.hasHostProps||(d.hasHostProps=!0),f.prototype._addPropertyEffect(m,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Ve()});
e=g;d.templatizeInstanceClass=e}k=Uc(b);f=c;if((g=f.forwardHostProp)&&d.hasHostProps){c="template"==b.localName;m=d.templatizeTemplateClass;if(!m){if(c){m=f.mutableData?Xe:Vc;class u extends m{}m=d.templatizeTemplateClass=u}else{m=b.constructor;class u extends m{}m=d.templatizeTemplateClass=u}h=d.hostProps;for(var n in h)m.prototype._addPropertyEffect("_host_"+n,m.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:Te(n,g)}),m.prototype._createNotifyingProperty("_host_"+n);if(Wc&&k){n=k.constructor._properties;
...
m.prototype),p=d.hostProps,p)r="_host_"+r,r in b&&(p=b[r],delete b[r],b.__data[r]=p)}r=class extends e{};r.prototype._methodHost=k;r.prototype.__dataHost=b;r.prototype.__templatizeOwner=a;r.prototype.__hostProps=d.hostProps;return r}function Hb(){if(ya&&!Qa){if(!Xc){Xc=!0;const b=document.createElement("style");b.textContent="dom-bind,dom-if,dom-repeat{display:none;}";document.head.appendChild(b)}return!0}return!1}class Ye extends HTMLElement{static get version(){return"1.6.1"}}customElements.define("vaadin-lumo-styles",
Ye);let eb=null,Zb=window.HTMLImports&&window.HTMLImports.whenReady||null,fb,Ra=null,Aa=null;class R{constructor(){this.customStyles=[];this.enqueued=!1;Yb(()=>{window.ShadyCSS.flushCustomStyles&&window.ShadyCSS.flushCustomStyles()})}enqueueDocumentValidation(){!this.enqueued&&Aa&&(this.enqueued=!0,Yb(Aa))}addCustomStyle(b){b.__seenByShadyCSS||(b.__seenByShadyCSS=!0,this.customStyles.push(b),this.enqueueDocumentValidation())}getStyleForCustomStyle(b){return b.__shadyCSSCachedStyle?b.__shadyCSSCachedStyle:
b.getStyle?b.getStyle():b}processStyles(){const b=this.customStyles;for(let c=0;c<b.length;c++){const d=b[c];if(!d.__shadyCSSCachedStyle){var a=this.getStyleForCustomStyle(d);a&&(a=a.__appliedElement||a,Ra&&Ra(a),d.__shadyCSSCachedStyle=a)}}return b}}R.prototype.addCustomStyle=R.prototype.addCustomStyle;R.prototype.getStyleForCustomStyle=R.prototype.getStyleForCustomStyle;R.prototype.processStyles=R.prototype.processStyles;Object.defineProperties(R.prototype,{transformCallback:{get(){return Ra},set(b){Ra=
b}},validateCallback:{get(){return Aa},set(b){let a=!1;Aa||(a=!0);Aa=b;a&&this.enqueueDocumentValidation()}}});const Ib=/(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,Sa=/(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,Fe=/@media\s(.*)/,Ga=!(window.ShadyDOM&&window.ShadyDOM.inUse);let hb,ua;window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(ua=window.ShadyCSS.cssBuild);const Yc=!(!window.ShadyCSS||!window.ShadyCSS.disableRuntime);
window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?hb=window.ShadyCSS.nativeCss:window.ShadyCSS?(ac(window.ShadyCSS),window.ShadyCSS=void 0):ac(window.WebComponents&&window.WebComponents.flags);const Ab=hb,Ta=new R;window.ShadyCSS||(window.ShadyCSS={prepareTemplate(b,a,c){},prepareTemplateDom(b,a){},prepareTemplateStyles(b,a,c){},styleSubtree(b,a){Ta.processStyles();gb(b,a)},styleElement(b){Ta.processStyles()},styleDocument(b){Ta.processStyles();gb(document.body,b)},getComputedStyleValue(b,a){return $b(b,
a)},flushCustomStyles(){},nativeCss:Ab,nativeShadow:Ga,cssBuild:ua,disableRuntime:Yc});window.ShadyCSS.CustomStyleInterface=Ta;window.JSCompiler_renameProperty=function(b,a){return b};let fe=/(url\()([^)]*)(\))/g,ee=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/,Ha,C;const Qa=!window.ShadyDOM||!window.ShadyDOM.inUse,Ze=Qa&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const b=new CSSStyleSheet;b.replaceSync("");const a=document.createElement("div");a.attachShadow({mode:"open"});
a.shadowRoot.adoptedStyleSheets=[b];return a.shadowRoot.adoptedStyleSheets[0]===b}catch(b){return!1}})();let $e=window.Polymer&&window.Polymer.rootPath||jb(document.baseURI||window.location.href),Ka=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,ve=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,ca=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,af=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,ya=window.Polymer&&window.Polymer.legacyOptimizations||!1,Wc=
window.Polymer&&window.Polymer.legacyWarnings||!1,bf=window.Polymer&&window.Polymer.syncInitialRender||!1,rb=window.Polymer&&window.Polymer.legacyUndefined||!1,cf=window.Polymer&&window.Polymer.orderedComputed||!1,Zc=window.Polymer&&window.Polymer.removeNestedTemplates||!1,$c=window.Polymer&&window.Polymer.fastDomIf||!1,Jb=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,Ua=window.Polymer&&window.Polymer.legacyNoObservedAttributes||!1,df=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||
!1,Ba={},Va={};class O extends HTMLElement{static get observedAttributes(){return["id"]}static import(b,a){return b?(b=Ba[b]||Va[b.toLowerCase()])&&a?b.querySelector(a):b:null}attributeChangedCallback(b,a,c,d){a!==c&&this.register()}get assetpath(){if(!this.__assetpath){var b=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument;b=la(this.getAttribute("assetpath")||"",b.baseURI);this.__assetpath=jb(b)}return this.__assetpath}register(b){if(b=
b||this.id){if(ca&&void 0!==(Ba[b]||Va[b.toLowerCase()]))throw Ba[b]=Va[b.toLowerCase()]=null,Error(`strictTemplatePolicy: dom-module ${b} re-registered`);this.id=b;Ba[b]=Va[b.toLowerCase()]=this;this.querySelector("style")&&console.warn("dom-module %s has style outside template",this.id)}}}O.prototype.modules=Ba;customElements.define("dom-module",O);const ef=window.ShadyCSS.CustomStyleInterface;class ff extends HTMLElement{constructor(){super();this._style=null;ef.addCustomStyle(this)}getStyle(){if(this._style)return this._style;
...
document.head.appendChild(fd.content);const K=function(b,...a){const c=document.createElement("template");c.innerHTML=a.reduce((d,e,f)=>{if(e instanceof HTMLTemplateElement)e=e.innerHTML;else throw Error(`non-template value passed to Polymer's html function: ${e}`);return d+e+b[f+1]},b[0]);return c},gf=K`<dom-module id="lumo-checkbox" theme-for="vaadin-checkbox">
  <template>
...
</dom-module>`;document.head.appendChild(gf.content);let hf=0;const D=function(b){let a=b.__mixinApplications;a||(a=new WeakMap,b.__mixinApplications=a);let c=hf++;return function(d){let e=d.__mixinSet;if(e&&e[c])return d;let f=a,g=f.get(d);g||(g=b(d),f.set(d,g),d=Object.create(g.__mixinSet||e||null),d[c]=!0,g.__mixinSet=d);return g}},q=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?b=>ShadyDOM.patch(b):b=>b,Ia={},je=/-[a-z]/g,ke=/([A-Z])/g;let jf=
0,gd=0,da=[],kf=0,Kb=!1,hd=document.createTextNode("");(new window.MutationObserver(function(){Kb=!1;const b=da.length;for(let a=0;a<b;a++){let c=da[a];if(c)try{c()}catch(d){setTimeout(()=>{throw d;})}}da.splice(0,b);gd+=b})).observe(hd,{characterData:!0});const G={after(b){return{run(a){return window.setTimeout(a,b)},cancel(a){window.clearTimeout(a)}}},run(b,a){return window.setTimeout(b,a)},cancel(b){window.clearTimeout(b)}},L={run(b){return window.requestAnimationFrame(b)},cancel(b){window.cancelAnimationFrame(b)}},
id={run(b){return window.requestIdleCallback?window.requestIdleCallback(b):window.setTimeout(b,16)},cancel(b){window.cancelIdleCallback?window.cancelIdleCallback(b):window.clearTimeout(b)}},F={run(b){Kb||(Kb=!0,hd.textContent=kf++);da.push(b);return jf++},cancel(b){const a=b-gd;if(0<=a){if(!da[a])throw Error("invalid async handle: "+b);da[a]=null}}},lf=F,jd=D(b=>{class a extends b{static createProperties(c){const d=this.prototype;for(let e in c)e in d||d._createPropertyAccessor(e)}static attributeNameForProperty(c){return c.toLowerCase()}static typeForProperty(c){}_createPropertyAccessor(c,
...
"":void 0;default:return null!=c?c.toString():void 0}}_deserializeValue(c,d){switch(d){case Boolean:return null!==c;case Number:return Number(c);default:return c}}}return a}),kd={};let Wa=HTMLElement.prototype;for(;Wa;){let b=Object.getOwnPropertyNames(Wa);for(let a=0;a<b.length;a++)kd[b[a]]=!0;Wa=Object.getPrototypeOf(Wa)}const ld=D(b=>{b=jd(b);class a extends b{static createPropertiesForAttributes(){let c=this.observedAttributes;for(let d=0;d<c.length;d++)this.prototype._createPropertyAccessor(ec(c[d]))}static attributeNameForProperty(c){return Ja(c)}_initializeProperties(){this.__dataProto&&
...
window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(c);d=d||this.constructor._parseTemplate(c);let e=d.nodeInfoList;c=document.importNode(d.content||c.content,!0);c.__noInsertionPoint=!d.hasInsertionPoint;let f=c.nodeList=Array(e.length);c.$={};for(let k=0,l=e.length,m;k<l&&(m=e[k]);k++){let n=f[k]=fc(c,m);m.id&&(c.$[m.id]=n);var g=n,h=d;m.templateInfo&&(g._templateInfo=m.templateInfo,g._parentTemplateInfo=h);g=n;h=m;if(h.events&&h.events.length)for(let p=0,r=h.events,
...
of=/[A-Z]/,od=(b,a,c,d,e)=>{var f=e?I(b):b;if(a=a[f])for(f=0;f<a.length;f++){var g=a[f];if(g.info.lastRun!==oa&&(!e||nb(b,g.trigger))){g.info.lastRun=oa;{g=g.info;var h=c,k=d;let l=0,m=h.length-1,n=-1;for(;l<=m;){const p=l+m>>1,r=k.get(h[p].methodInfo)-k.get(g.methodInfo);if(0>r)l=p+1;else if(0<r)m=p-1;else{n=p;break}}0>n&&(n=m+1);h.splice(n,0,g)}}}},se=[],pd=/(\[\[|{{)\s*(?:(!)\s*)?((?:[a-zA-Z_$][\w.:$\-*]*)\s*(?:\(\s*(?:(?:(?:((?:[a-zA-Z_$][\w.:$\-*]*)|(?:[-+]?[0-9]*\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\]|\\.)*')|(?:"(?:[^"\\]|\\.)*")))\s*)(?:,\s*(?:((?:[a-zA-Z_$][\w.:$\-*]*)|(?:[-+]?[0-9]*\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\]|\\.)*')|(?:"(?:[^"\\]|\\.)*")))\s*))*)?)\)\s*)?)(?:]]|}})/g,
Xa=D(b=>{const a=nf(ld(b));class c extends a{constructor(){super();this.__isPropertyEffectsClient=!0}get PROPERTY_EFFECT_TYPES(){return t}_initializeProperties(){super._initializeProperties();this._registerHost();this.__dataClientsReady=!1;this.__dataLinkedPaths=this.__dataToNotify=this.__dataPendingClients=null;this.__dataHasPaths=!1;this.__dataCompoundStorage=this.__dataCompoundStorage||null;this.__dataHost=this.__dataHost||null;this.__dataTemp={};this.__dataClientsInitialized=!1}_registerHost(){if(Ca.length){let d=
...
{path:""};e=A(this,d,f);f=f.path}else f=Array.isArray(d)?ma(d):d;this._setPendingPropertyOrPath(f,e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(d,e){this._addPropertyEffect(d,t.READ_ONLY);e&&(this["_set"+ue(d)]=function(f){this._setProperty(d,f)})}_createPropertyObserver(d,e,f){let g={property:d,method:e,dynamicFn:!!f};this._addPropertyEffect(d,t.OBSERVE,{fn:gc,info:g,trigger:{name:d}});f&&this._addPropertyEffect(e,t.OBSERVE,{fn:gc,info:g,trigger:{name:e}})}_createMethodObserver(d,
e){let f=qb(d);if(!f)throw Error("Malformed observer expression '"+d+"'");kc(this,f,t.OBSERVE,ob,null,e)}_createNotifyingProperty(d){this._addPropertyEffect(d,t.NOTIFY,{fn:me,info:{eventName:Ja(d)+"-changed",property:d}})}_createReflectedProperty(d){let e=this.constructor.attributeNameForProperty(d);"-"===e[0]?console.warn("Property "+d+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(d,
t.REFLECT,{fn:ne,info:{attrName:e}})}_createComputedProperty(d,e,f){let g=qb(e);if(!g)throw Error("Malformed computed expression '"+e+"'");e=kc(this,g,t.COMPUTE,ic,d,f);mb(this,"__computeInfo")[d]=e}_marshalArgs(d,e,f){const g=this.__data,h=[];for(let k=0,l=d.length;k<l;k++){let {name:m,structured:n,wildcard:p,value:r,literal:u}=d[k];if(!u)if(p){const z=0===e.indexOf(m+"."),E=mc(g,f,z?e:m);r={path:z?e:m,value:E,base:z?A(g,m):E}}else r=n?mc(g,f,m):g[m];if(rb&&!this._overrideLegacyUndefined&&void 0===
...
0;r<p.length;r++){let u=p[r];f=n;g=u;if(g.isCompound){let z=f.__dataCompoundStorage||(f.__dataCompoundStorage={});var h=g.parts;let E=Array(h.length);for(let S=0;S<h.length;S++)E[S]=h[S].literal;h=g.target;z[h]=E;g.literal&&"property"==g.kind&&("className"===h&&(f=q(f)),f[h]=g.literal)}re(n,this,u)}n.__dataHost=this}}this.__dataClientsReady&&(this._runEffectsForTemplate(e,this.__data,null,!1),this._flushClients());return d}_removeBoundDom(d){d=d.templateInfo;const {previousSibling:e,nextSibling:f,
parent:g}=d;e?e.nextSibling=f:g&&(g.firstChild=f);f?f.previousSibling=e:g&&(g.lastChild=e);d.nextSibling=d.previousSibling=null;d=d.childNodes;for(let h=0;h<d.length;h++){let k=d[h];q(q(k).parentNode).removeChild(k)}}static _parseTemplateNode(d,e,f){let g=a._parseTemplateNode.call(this,d,e,f);if(d.nodeType===Node.TEXT_NODE){let h=this._parseBindings(d.textContent,e);h&&(d.textContent=lc(h)||" ",pb(this,e,f,"text","textContent",h),g=!0)}return g}static _parseTemplateNodeAttribute(d,e,f,g,h){let k=
this._parseBindings(h,e);if(k){h=g;let l="property";of.test(g)?l="attribute":"$"==g[g.length-1]&&(g=g.slice(0,-1),l="attribute");let m=lc(k);m&&"attribute"==l&&("class"==g&&d.hasAttribute("class")&&(m+=" "+d.getAttribute(g)),d.setAttribute(g,m));"attribute"==l&&"disable-upgrade$"==h&&d.setAttribute(g,"");"input"===d.localName&&"value"===h&&d.setAttribute(h,"");d.removeAttribute(h);"property"===l&&(g=ec(g));pb(this,e,f,l,g,k,m);return!0}return a._parseTemplateNodeAttribute.call(this,d,e,f,g,h)}static _parseTemplateNestedTemplate(d,
e,f){let g=a._parseTemplateNestedTemplate.call(this,d,e,f);const h=d.parentNode,k=f.templateInfo,l="dom-if"===h.localName,m="dom-repeat"===h.localName;Zc&&(l||m)&&(h.removeChild(d),f=f.parentInfo,f.templateInfo=k,f.noted=!0,g=!1);d=k.hostProps;if($c&&l)d&&(e.hostProps=Object.assign(e.hostProps||{},d),Zc||(f.parentInfo.noted=!0));else for(let n in d)pb(this,e,f,"property","_host_"+n,[{mode:"{",source:n,dependencies:[n],hostProp:!0}]);return g}static _parseBindings(d,e){let f=[];for(var g=0,h;null!==
(h=pd.exec(d));){h.index>g&&f.push({literal:d.slice(g,h.index)});g=h[1][0];let m=!!h[2];h=h[3].trim();let n=!1,p="";var k=-1;"{"==g&&0<(k=h.indexOf("::"))&&(p=h.substring(k+2),h=h.substring(0,k),n=!0);k=qb(h);let r=[];if(k){let {args:u,methodName:z}=k;for(var l=0;l<u.length;l++){let E=u[l];E.literal||r.push(E)}if((l=e.dynamicFns)&&l[z]||k.static)r.push(z),k.dynamicFn=!0}else r.push(h);f.push({source:h,mode:g,negate:m,customEvent:n,signature:k,dependencies:r,event:p});g=pd.lastIndex}g&&g<d.length&&
(d=d.substring(g))&&f.push({literal:d});return f.length?f:null}static _evaluateBinding(d,e,f,g,h,k){d=e.signature?ob(d,f,g,h,e.signature):f!=e.source?A(d,e.source):k&&0<=f.indexOf(".")?A(d,f):d.__data[f];e.negate&&(d=!d);return d}}return c}),Ca=[],rf=D(b=>{function a(e){e=Object.getPrototypeOf(e);return e.prototype instanceof d?e:null}function c(e){if(!e.hasOwnProperty("__ownProperties")){var f=null;if(e.hasOwnProperty("properties")){var g=e.properties;if(g){f=g;g={};for(let h in f){const k=f[h];
g[h]="function"===typeof k?{type:k}:k}f=g}}e.__ownProperties=f}return e.__ownProperties}b=jd(b);class d extends b{static get observedAttributes(){if(!this.hasOwnProperty("__observedAttributes")){const e=this._properties;this.__observedAttributes=e?Object.keys(e).map(f=>this.prototype._addPropertyToAttributeMap(f)):[]}return this.__observedAttributes}static finalize(){if(!this.hasOwnProperty("__finalized")){const e=a(this);e&&e.finalize();this.__finalized=!0;this._finalizeClass()}}static _finalizeClass(){const e=
...
super._initializeProperties();this.rootPath=$e;this.importPath=this.constructor.importPath;var e=this.constructor;if(!e.hasOwnProperty("__propertyDefaults")){e.__propertyDefaults=null;var f=e._properties;for(let g in f){let h=f[g];"value"in h&&(e.__propertyDefaults=e.__propertyDefaults||{},e.__propertyDefaults[g]=h)}}if(e=e.__propertyDefaults)for(let g in e)f=e[g],this._canApplyPropertyDefault(g)&&(f="function"==typeof f.value?f.value.call(this):f.value,this._hasAccessor(g)?this._setPendingProperty(g,
...
this.$=this.root.$);super.ready()}_readyClients(){this._template&&(this.root=this._attachDom(this.root));super._readyClients()}_attachDom(e){const f=q(this);if(f.attachShadow)return e?(f.shadowRoot||(f.attachShadow({mode:"open",shadyUpgradeFragment:e}),f.shadowRoot.appendChild(e),this.constructor._styleSheet&&(f.shadowRoot.adoptedStyleSheets=[this.constructor._styleSheet])),bf&&window.ShadyDOM&&window.ShadyDOM.flushInitial(f.shadowRoot),f.shadowRoot):null;throw Error("ShadowDOM not available. PolymerElement can create dom as children instead of in ShadowDOM by setting `this.root \x3d this;` before `ready`.");
}updateStyles(e){window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,e)}resolveUrl(e,f){!f&&this.importPath&&(f=la(this.importPath));return la(e,f)}static _parseTemplateContent(e,f,g){f.dynamicFns=f.dynamicFns||this._properties;return c._parseTemplateContent.call(this,e,f,g)}static _addTemplatePropertyEffect(e,f,g){!Wc||f in this._properties||g.info.part.signature&&g.info.part.signature.static||g.info.part.hostProp||e.nestedTemplate||console.warn(`Property '${f}' used in template but not declared in 'properties'; `+
"attribute will not be observed.");return c._addTemplatePropertyEffect.call(this,e,f,g)}}return d}),M=Ya(HTMLElement);class v{constructor(){this._timer=this._callback=this._asyncModule=null}setConfig(b,a){this._asyncModule=b;this._callback=a;this._timer=this._asyncModule.run(()=>{this._timer=null;U.delete(this);this._callback()})}cancel(){this.isActive()&&(this._cancelAsync(),U.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&
(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(b,a,c){b instanceof v?b._cancelAsync():b=new v;b.setConfig(a,c);return b}}let U=new Set;const sf=function(){const b=!!U.size;U.forEach(a=>{try{a.flush()}catch(c){setTimeout(()=>{throw c;})}});return b};let sb="string"===typeof document.head.style.touchAction,La=["mousedown","mousemove","mouseup","click"],xe=[0,1,4,2];try{var rd=1===(new MouseEvent("test",{buttons:1})).buttons}catch(b){rd=!1}let we=rd,tb=!1;(function(){try{let b=
Object.defineProperty({},"passive",{get(){tb=!0}});window.addEventListener("test",null,b);window.removeEventListener("test",null,b)}catch(b){}})();let qc=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const ub=[],tf={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},ze={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};let rc=function(b){var a=b.sourceCapabilities;if(!a||a.firesTouchEvents)if(b.__polymerGesturesHandled=
{skip:!0},"click"===b.type){a=!1;let f=Ma(b);for(let g=0;g<f.length;g++){if(f[g].nodeType===Node.ELEMENT_NODE)if("label"===f[g].localName)ub.push(f[g]);else if(tf[f[g].localName]){var c=f[g];var d=Array.prototype.slice.call(c.labels||[]);if(!d.length){d=[];var e=c.getRootNode();if(c.id)for(c=e.querySelectorAll(`label[for = ${c.id}]`),e=0;e<c.length;e++)d.push(c[e])}for(c=0;c<d.length;c++)a=a||-1<ub.indexOf(d[c])}if(f[g]===y.mouse.target)return}a||(b.preventDefault(),b.stopPropagation())}},y={mouse:{target:null,
mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};document.addEventListener("touchend",function(b){y.mouse.mouseIgnoreJob||pc(!0);y.mouse.target=Ma(b)[0];y.mouse.mouseIgnoreJob=v.debounce(y.mouse.mouseIgnoreJob,G.after(2500),function(){pc();y.mouse.target=null;y.mouse.mouseIgnoreJob=null})},tb?{passive:!0}:!1);const Ma=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:b=>b.composedPath&&b.composedPath()||[],ra={},Y=[];wb({name:"downup",deps:["mousedown","touchstart",
"touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){aa(this.info)},mousedown:function(b){if(X(b)){var a=P(b),c=this;sc(this.info,function(d){X(d)||(sa("up",a,d),aa(c.info))},function(d){X(d)&&sa("up",a,d);aa(c.info)});sa("down",a,b)}},touchstart:function(b){sa("down",P(b),b.changedTouches[0],b)},touchend:function(b){sa("up",P(b),b.changedTouches[0],b)}});wb({name:"track",touchAction:"none",deps:["mousedown",
...
g=e.clientY;vc(c.info,f,g)&&(c.info.state=c.info.started?"mouseup"===e.type?"end":"track":"start","start"===c.info.state&&Na("tap"),c.info.addMove({x:f,y:g}),X(e)||(c.info.state="end",aa(c.info)),a&&yb(c.info,a,e),c.info.started=!0)};sc(this.info,d,function(e){c.info.started&&d(e);aa(c.info)});this.info.x=b.clientX;this.info.y=b.clientY}},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchmove:function(b){let a=P(b);b=b.changedTouches[0];let c=b.clientX,
d=b.clientY;vc(this.info,c,d)&&("start"===this.info.state&&Na("tap"),this.info.addMove({x:c,y:d}),yb(this.info,a,b),this.info.state="track",this.info.started=!0)},touchend:function(b){let a=P(b);b=b.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:b.clientX,y:b.clientY}),yb(this.info,a,b))}});wb({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},
reset:function(){this.info.x=NaN;this.info.y=NaN;this.info.prevent=!1},mousedown:function(b){X(b)&&(this.info.x=b.clientX,this.info.y=b.clientY)},click:function(b){X(b)&&wc(this.info,b)},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchend:function(b){wc(this.info,b.changedTouches[0],b)}});const Da=D(b=>{class a extends b{_addEventListenerToNode(c,d,e){vb(c,d,e)||super._addEventListenerToNode(c,d,e)}_removeEventListenerFromNode(c,d,e){if(ra[d]){{var f=
ra[d];var g=f.deps;f=f.name;let h=c.__polymerGestures;if(h)for(let k=0,l,m;k<g.length;k++)l=g[k],(m=h[l])&&m[f]&&(m[f]=(m[f]||1)-1,m._count=(m._count||1)-1,0===m._count&&c.removeEventListener(l,tc,oc(l)));c.removeEventListener(d,e)}g=!0}else g=!1;g||super._removeEventListenerFromNode(c,d,e)}}return a}),uf=b=>class extends b{static get properties(){return{theme:{type:String,readOnly:!0}}}attributeChangedCallback(a,c,d){super.attributeChangedCallback(a,c,d);"theme"===a&&this._setTheme(d)}},Nb=b=>class extends uf(b){static finalize(){super.finalize();
...
a);c.content.appendChild(d)}}};let Ob=!1;window.addEventListener("keydown",()=>{Ob=!0},{capture:!0});window.addEventListener("mousedown",()=>{Ob=!1},{capture:!0});const vf=b=>class extends b{static get properties(){var a={tabindex:{type:Number,value:0,reflectToAttribute:!0,observer:"_tabindexChanged"}};window.ShadyDOM&&(a.tabIndex=a.tabindex);return a}},wf=b=>class extends vf(b){static get properties(){return{autofocus:{type:Boolean},_previousTabIndex:{type:Number},disabled:{type:Boolean,observer:"_disabledChanged",
reflectToAttribute:!0},_isShiftTabbing:{type:Boolean}}}ready(){this.addEventListener("focusin",c=>{c.composedPath()[0]===this?this.contains(c.relatedTarget)||this._focus():-1===c.composedPath().indexOf(this.focusElement)||this.disabled||this._setFocused(!0)});this.addEventListener("focusout",c=>this._setFocused(!1));super.ready();const a=c=>{c.composed||c.target.dispatchEvent(new CustomEvent(c.type,{bubbles:!0,composed:!0,cancelable:!1}))};this.shadowRoot.addEventListener("focusin",a);this.shadowRoot.addEventListener("focusout",
a);this.addEventListener("keydown",c=>{if(!c.defaultPrevented&&9===c.keyCode)if(c.shiftKey)this._isShiftTabbing=!0,HTMLElement.prototype.focus.apply(this),this._setFocused(!1),setTimeout(()=>this._isShiftTabbing=!1,0);else if((c=window.navigator.userAgent.match(/Firefox\/(\d\d\.\d)/))&&63<=parseFloat(c[1])&&66>parseFloat(c[1])&&this.parentNode&&this.nextSibling){const d=document.createElement("input");d.style.position="absolute";d.style.opacity="0";d.tabIndex=this.tabIndex;this.parentNode.insertBefore(d,
this.nextSibling);d.focus();d.addEventListener("focusout",()=>this.parentNode.removeChild(d))}});this.autofocus&&!this.disabled&&window.requestAnimationFrame(()=>{this._focus();this._setFocused(!0);this.setAttribute("focus-ring","")})}disconnectedCallback(){super.disconnectedCallback();this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(a){a?this.setAttribute("focused",""):this.removeAttribute("focused");a&&Ob?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`);
...
this.removeAttribute("aria-disabled"))}_tabindexChanged(a){void 0!==a&&(this.focusElement.tabIndex=a);this.disabled&&this.tabindex&&(-1!==this.tabindex&&(this._previousTabIndex=this.tabindex),this.tabindex=a=void 0);window.ShadyDOM&&this.setProperties({tabIndex:a,tabindex:a})}click(){this.disabled||super.click()}},ea=function(){let b,a;do b=window.ShadyDOM&&ShadyDOM.flush(),window.ShadyCSS&&window.ShadyCSS.ScopingShim&&window.ShadyCSS.ScopingShim.flush(),a=sf();while(b||a)};class Pb{static detectScrollType(){const b=
document.createElement("div");b.textContent="ABCD";b.dir="rtl";b.style.fontSize="14px";b.style.width="4px";b.style.height="1px";b.style.position="absolute";b.style.top="-1000px";b.style.overflow="scroll";document.body.appendChild(b);let a="reverse";0<b.scrollLeft?a="default":(b.scrollLeft=2,2>b.scrollLeft&&(a="negative"));document.body.removeChild(b);return a}static getNormalizedScrollLeft(b,a,c){const {scrollLeft:d}=c;if("rtl"!==a||!b)return d;switch(b){case "negative":return c.scrollWidth-c.clientWidth+
d;case "reverse":return c.scrollWidth-c.clientWidth-d}return d}static setNormalizedScrollLeft(b,a,c,d){if("rtl"===a&&b)switch(b){case "negative":c.scrollLeft=c.clientWidth-c.scrollWidth+d;break;case "reverse":c.scrollLeft=c.scrollWidth-c.clientWidth-d;break;default:c.scrollLeft=d}else c.scrollLeft=d}}const V=[];let Za;(new MutationObserver(function(){const b=fa();V.forEach(a=>{Qb(a,b)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Qb=function(b,a){a?b.setAttribute("dir",
a):b.removeAttribute("dir")},fa=function(){return document.documentElement.getAttribute("dir")},Rb=b=>class extends b{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize();Za||(Za=Pb.detectScrollType())}connectedCallback(){super.connectedCallback();this.hasAttribute("dir")||(this.__subscribe(),Qb(this,fa()))}attributeChangedCallback(a,c,d){super.attributeChangedCallback(a,c,d);if("dir"===a){a=d===fa()&&-1===V.indexOf(this);var e=!d&&c&&-1===V.indexOf(this);
c=d!==fa()&&c===fa();a||e?(this.__subscribe(),Qb(this,fa())):c&&this.__subscribe(!1)}}disconnectedCallback(){super.disconnectedCallback();this.__subscribe(!1);this.removeAttribute("dir")}__subscribe(a=!0){a?-1===V.indexOf(this)&&V.push(this):-1<V.indexOf(this)&&V.splice(V.indexOf(this),1)}__getNormalizedScrollLeft(a){return Pb.getNormalizedScrollLeft(Za,this.getAttribute("dir")||"ltr",a)}__setNormalizedScrollLeft(a,c){return Pb.setNormalizedScrollLeft(Za,this.getAttribute("dir")||"ltr",a,c)}},Ce=
/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Oa=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;window.Vaadin=window.Vaadin||{};const sd=function(b,a){if(window.Vaadin.developmentMode)return xc(b,a)};if(void 0===window.Vaadin.developmentMode){var xf=window.Vaadin;try{var td=localStorage.getItem("vaadin.developmentmode.force")?!0:0<=["localhost","127.0.0.1"].indexOf(window.location.hostname)?Oa?!Be():!Ae():!1}catch(b){td=!1}xf.developmentMode=td}const ud=function(){if("function"===
typeof sd)return sd(De)};window.Vaadin||(window.Vaadin={});window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{};window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){ud&&ud()};let Sb;const vd=new Set,wd=b=>class extends Rb(b){static finalize(){super.finalize();const {is:a}=this;a&&!vd.has(a)&&(window.Vaadin.registrations.push(this),vd.add(a),window.Vaadin.developmentModeCallback&&(Sb=v.debounce(Sb,
id,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),U.add(Sb)))}constructor(){super();null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add \x3c!DOCTYPE html\x3e to the HTML document.')}};class xd extends wd(wf(Nb(Da(M)))){static get template(){return K`
    <style>
      :host {
        display: inline-block;
      }
...
</dom-module>`;document.head.appendChild(yf.content);class zc{constructor(){this.end=this.start=0;this.rules=this.parent=this.previous=null;this.cssText=this.parsedCssText="";this.atRule=!1;this.type=0;this.parsedSelector=this.selector=this.keyframesName=""}}const Q={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1E3},J={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},yd=new Set,zf=/;\s*/m,Af=/^\s*(initial)|(inherit)\s*$/,zd=/\s*!important/;class Bf{constructor(){this._map={}}set(b,a){b=b.trim();this._map[b]={properties:a,dependants:{}}}get(b){b=b.trim();return this._map[b]||null}}let $a=null;class B{constructor(){this._measureElement=this._currentElement=null;this._map=new Bf}detectMixin(b){b=Sa.test(b)||
Ib.test(b);Sa.lastIndex=0;Ib.lastIndex=0;return b}gatherStyles(b){var a=[];var c=b.content.querySelectorAll("style");for(let d=0;d<c.length;d++){const e=c[d];if(e.hasAttribute("shady-unscoped")){if(!Ga){{const f=e.textContent;if(!yd.has(f)){yd.add(f);const g=document.createElement("style");g.setAttribute("shady-unscoped","");g.textContent=f;document.head.appendChild(g)}}e.parentNode.removeChild(e)}}else a.push(e.textContent),e.parentNode.removeChild(e)}return(a=a.join("").trim())?(c=document.createElement("style"),
c.textContent=a,b.content.insertBefore(c,b.content.firstChild),c):null}transformTemplate(b,a){void 0===b._gatheredStyle&&(b._gatheredStyle=this.gatherStyles(b));return(b=b._gatheredStyle)?this.transformStyle(b,a):null}transformStyle(b,a=""){let c=Cc(b);this.transformRules(c,a);b.textContent=zb(c);return c}transformCustomStyle(b){let a=Cc(b);ta(a,c=>{":root"===c.selector&&(c.selector="html");this.transformRule(c)});b.textContent=zb(a);return a}transformRules(b,a){this._currentElement=a;ta(b,c=>{this.transformRule(c)});
...
return window.getComputedStyle(this._measureElement).getPropertyValue(b)}_fallbacksFromPreviousRules(b){let a=b;for(;a.parent;)a=a.parent;const c={};let d=!1;ta(a,e=>{(d=d||e===b)||e.selector===b.selector&&Object.assign(c,this._cssTextToMap(e.parsedCssText))});return c}_consumeCssProperties(b,a){for(var c=null;c=Sa.exec(b);){var d=c[0],e=c[1];c=c.index;var f=c+d.indexOf("@apply");let g=c+d.length;d=b.slice(0,f);b=b.slice(g);f=a?this._fallbacksFromPreviousRules(a):{};Object.assign(f,this._cssTextToMap(d));
e=this._atApplyToCssProperties(e,f);b=`${d}${e}${b}`;Sa.lastIndex=c+e.length}return b}_atApplyToCssProperties(b,a){b=b.replace(zf,"");let c=[];var d=this._map.get(b);d||(this._map.set(b,{}),d=this._map.get(b));if(d){this._currentElement&&(d.dependants[this._currentElement]=!0);let e,f;const g=d.properties;for(e in g)f=a&&a[e],d=[e,": var(",b,"_-_",e],f&&d.push(",",f.replace(zd,"")),d.push(")"),zd.test(g[e])&&d.push(" !important"),c.push(d.join(""))}return c.join("; ")}_replaceInitialOrInherit(b,a){let c=
Af.exec(a);c&&(a=c[1]?this._getInitialValueForProperty(b):"apply-shim-inherit");return a}_cssTextToMap(b,a=!1){b=b.split(";");let c,d,e={};for(let f=0,g,h;f<b.length;f++)if(g=b[f])h=g.split(":"),1<h.length&&(c=h[0].trim(),d=h.slice(1).join(":"),a&&(d=this._replaceInitialOrInherit(c,d)),e[c]=d);return e}_invalidateMixinEntry(b){if($a)for(let a in b.dependants)a!==this._currentElement&&$a(a)}_produceCssProperties(b,a,c,d,e){c&&Dc(c,(r,u)=>{u&&this._map.get(u)&&(d=`@apply ${u};`)});if(!d)return b;var f=
...
B.prototype.transformCustomStyle=B.prototype.transformCustomStyle;B.prototype.transformRules=B.prototype.transformRules;B.prototype.transformRule=B.prototype.transformRule;B.prototype.transformTemplate=B.prototype.transformTemplate;B.prototype._separator="_-_";Object.defineProperty(B.prototype,"invalidCallback",{get(){return $a},set(b){$a=b}});const Bb={},Ie=Promise.resolve(),Ea=new B;class Cf{constructor(){this.customStyleInterface=null;Ea.invalidCallback=Ge}ensure(){!this.customStyleInterface&&
window.ShadyCSS.CustomStyleInterface&&(this.customStyleInterface=window.ShadyCSS.CustomStyleInterface,this.customStyleInterface.transformCallback=b=>{Ea.transformCustomStyle(b)},this.customStyleInterface.validateCallback=()=>{requestAnimationFrame(()=>{this.customStyleInterface.enqueued&&this.flushCustomStyles()})})}prepareTemplate(b,a){this.ensure();""===Ec(b)&&(Bb[a]=b,a=Ea.transformTemplate(b,a),b._styleAst=a)}flushCustomStyles(){this.ensure();if(this.customStyleInterface){var b=this.customStyleInterface.processStyles();
...
var c="";let d="";a?-1<a.indexOf("-")?c=a:(d=a,c=b.getAttribute&&b.getAttribute("is")||""):(c=b.is,d=b.extends);a={is:c,typeExtension:d}}({is:c}=a);a=Bb[c];if((!a||""===Ec(a))&&a&&!Fc(a)){if(Fc(a)||a._applyShimValidatingVersion!==a._applyShimNextVersion)this.prepareTemplate(a,c),He(a);if(b=b.shadowRoot)if(b=b.querySelector("style"))b.__cssRules=a._styleAst,b.textContent=zb(a._styleAst)}}styleDocument(b){this.ensure();this.styleSubtree(document.body,b)}}if(!window.ShadyCSS||!window.ShadyCSS.ScopingShim){const b=
new Cf;let a=window.ShadyCSS&&window.ShadyCSS.CustomStyleInterface;window.ShadyCSS={prepareTemplate(c,d,e){b.flushCustomStyles();b.prepareTemplate(c,d)},prepareTemplateStyles(c,d,e){window.ShadyCSS.prepareTemplate(c,d,e)},prepareTemplateDom(c,d){},styleSubtree(c,d){b.flushCustomStyles();b.styleSubtree(c,d)},styleElement(c){b.flushCustomStyles();b.styleElement(c)},styleDocument(c){b.flushCustomStyles();b.styleDocument(c)},getComputedStyleValue(c,d){return $b(c,d)},flushCustomStyles(){b.flushCustomStyles()},
nativeCss:Ab,nativeShadow:Ga,cssBuild:ua,disableRuntime:Yc};a&&(window.ShadyCSS.CustomStyleInterface=a)}window.ShadyCSS.ApplyShim=Ea;const Df=/:host\(:dir\((ltr|rtl)\)\)/g,Ef=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Ff=/:dir\((?:ltr|rtl)\)/,Ad=!(!window.ShadyDOM||!window.ShadyDOM.inUse),wa=[];let Fa=null,va="";const Gf=D(b=>{Ad||Fa||(va=document.documentElement.getAttribute("dir"),Fa=new MutationObserver(Gc),Fa.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const a=ld(b);
class c extends a{static _processStyleText(d,e){d=a._processStyleText.call(this,d,e);!Ad&&Ff.test(d)&&(d=this._replaceDirInCssText(d),this.__activateDir=!0);return d}static _replaceDirInCssText(d){d=d.replace(Df,':host([dir\x3d"$1"])');return d=d.replace(Ef,':host([dir\x3d"$2"]) $1')}constructor(){super();this.__autoDirOptOut=!1}ready(){super.ready();this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){a.prototype.connectedCallback&&super.connectedCallback();this.constructor.__activateDir&&
(Fa&&Fa.takeRecords().length&&Gc(),wa.push(this),this.__autoDirOptOut||this.setAttribute("dir",va))}disconnectedCallback(){a.prototype.disconnectedCallback&&super.disconnectedCallback();if(this.constructor.__activateDir){const d=wa.indexOf(this);-1<d&&wa.splice(d,1)}}}c.__activateDir=!1;return c});let Pa=!1,Ic=[],Jc=[];"interactive"===document.readyState||"complete"===document.readyState?Lc():window.addEventListener("DOMContentLoaded",Lc);let Z=class{static getFlattenedNodes(b){const a=q(b);return ba(b)?
...
this.node.localName?q(this.node).assignedNodes({flatten:!0}):[]}getDestinationInsertionPoints(){let b=[],a=q(this.node).assignedSlot;for(;a;)b.push(a),a=q(a).assignedSlot;return b}importNode(b,a){return q(this.node instanceof Document?this.node:this.node.ownerDocument).importNode(b,a)}getEffectiveChildNodes(){return Z.getFlattenedNodes(this.node)}queryDistributedElements(b){let a=this.getEffectiveChildNodes(),c=[];for(let d=0,e=a.length,f;d<e&&(f=a[d]);d++)f.nodeType===Node.ELEMENT_NODE&&Bd.call(f,
b)&&c.push(f);return c}get activeElement(){let b=this.node;return void 0!==b._activeElement?b._activeElement:b.activeElement}}class Tb{constructor(b){this.event=b}get rootTarget(){return this.path[0]}get localTarget(){return this.event.target}get path(){return this.event.composedPath()}}let Ub=ia;if(window.ShadyDOM&&window.ShadyDOM.inUse&&window.ShadyDOM.noPatch&&window.ShadyDOM.Wrapper){class b extends window.ShadyDOM.Wrapper{}Object.getOwnPropertyNames(ia.prototype).forEach(a=>{"activeElement"!=
a&&(b.prototype[a]=ia.prototype[a])});Nc(b.prototype,["classList"]);Ub=b;Object.defineProperties(Tb.prototype,{localTarget:{get(){var a=this.event.currentTarget;a=a&&N(a).getOwnerRoot();const c=this.path;for(let d=0;d<c.length;d++){const e=c[d];if(N(e).getOwnerRoot()===a)return e}},configurable:!0},path:{get(){return window.ShadyDOM.composedPath(this.event)},configurable:!0}})}else Ne(ia.prototype,"cloneNode appendChild insertBefore removeChild replaceChild setAttribute removeAttribute querySelector querySelectorAll".split(" ")),
Nc(ia.prototype,"parentNode firstChild lastChild nextSibling previousSibling firstElementChild lastElementChild nextElementSibling previousElementSibling childNodes children classList".split(" ")),Oe(ia.prototype,["textContent","innerHTML","className"]);const N=function(b){b=b||document;if(b instanceof Ub||b instanceof Tb)return b;let a=b.__domApi;a||(a=b instanceof Event?new Tb(b):new Ub(b),b.__domApi=a);return a},Cb=window.ShadyDOM,Oc=window.ShadyCSS,Cd=b=>{for(;b;){const a=Object.getOwnPropertyDescriptor(b,
"observedAttributes");if(a)return a.get;b=Object.getPrototypeOf(b.prototype).constructor}return()=>[]};D(b=>{b=Ya(b);let a=Cd(b);class c extends b{constructor(){super()}static get observedAttributes(){return a.call(this).concat("disable-upgrade")}_initializeProperties(){this.hasAttribute("disable-upgrade")?this.__isUpgradeDisabled=!0:super._initializeProperties()}_enableProperties(){this.__isUpgradeDisabled||super._enableProperties()}_canApplyPropertyDefault(d){return super._canApplyPropertyDefault(d)&&
!(this.__isUpgradeDisabled&&this._isPropertyPending(d))}attributeChangedCallback(d,e,f,g){"disable-upgrade"==d?this.__isUpgradeDisabled&&null==f&&(super._initializeProperties(),this.__isUpgradeDisabled=!1,q(this).isConnected&&super.connectedCallback()):super.attributeChangedCallback(d,e,f,g)}connectedCallback(){this.__isUpgradeDisabled||super.connectedCallback()}disconnectedCallback(){this.__isUpgradeDisabled||super.disconnectedCallback()}}return c});let Hf=window.ShadyCSS;const Dd=D(b=>{b=Da(Ya(b));
b=Mb?b:Gf(b);const a=Cd(b),c={x:"pan-x",y:"pan-y",none:"none",all:"auto"};class d extends b{constructor(){super()}static get importMeta(){return this.prototype.importMeta}created(){}__attributeReaction(e,f,g){(this.__dataAttributes&&this.__dataAttributes[e]||"disable-upgrade"===e)&&this.attributeChangedCallback(e,f,g,null)}setAttribute(e,f){if(Ua&&!this._legacyForceObservedAttributes){const g=this.getAttribute(e);super.setAttribute(e,f);this.__attributeReaction(e,g,String(f))}else super.setAttribute(e,
f)}removeAttribute(e){if(Ua&&!this._legacyForceObservedAttributes){const f=this.getAttribute(e);super.removeAttribute(e);this.__attributeReaction(e,f,null)}else super.removeAttribute(e)}static get observedAttributes(){return Ua&&!this.prototype._legacyForceObservedAttributes?(this.hasOwnProperty("__observedAttributes")||(this.__observedAttributes=[]),this.__observedAttributes):a.call(this).concat("disable-upgrade")}_enableProperties(){this.__isUpgradeDisabled||super._enableProperties()}_canApplyPropertyDefault(e){return super._canApplyPropertyDefault(e)&&
...
e&&q(this).contains(e)&&q(this).getRootNode()===q(e).getRootNode()}isLocalDescendant(e){return this.root===q(e).getRootNode()}scopeSubtree(e,f=!1){return Pe(e,f)}getComputedStyleValue(e){return Hf.getComputedStyleValue(this,e)}debounce(e,f,g){this._debouncers=this._debouncers||{};return this._debouncers[e]=v.debounce(this._debouncers[e],0<g?G.after(g):F,f.bind(this))}isDebouncerActive(e){this._debouncers=this._debouncers||{};e=this._debouncers[e];return!(!e||!e.isActive())}flushDebouncer(e){this._debouncers=
this._debouncers||{};(e=this._debouncers[e])&&e.flush()}cancelDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.cancel()}async(e,f){return 0<f?G.run(e.bind(this),f):~F.run(e.bind(this))}cancelAsync(e){0>e?F.cancel(~e):G.cancel(e)}create(e,f){e=document.createElement(e);if(f)if(e.setProperties)e.setProperties(f);else for(let g in f)e[g]=f[g];return e}elementMatches(e,f){return Bd.call(f||this,e)}toggleAttribute(e,f){let g=this;3===arguments.length&&(g=arguments[2]);1==arguments.length&&
...
f,1);return null}_logger(e,f){Array.isArray(f)&&1===f.length&&Array.isArray(f[0])&&(f=f[0]);switch(e){case "log":case "warn":case "error":console[e](...f)}}_log(...e){this._logger("log",e)}_warn(...e){this._logger("warn",e)}_error(...e){this._logger("error",e)}_logf(e,...f){return["[%s::%s]",this.is,e,...f]}}d.prototype.is="";return d}),Qe={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,listeners:!0,hostAttributes:!0},Sc={attached:!0,detached:!0,ready:!0,
created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,behaviors:!0,_noAccessors:!0},Se=Object.assign({listeners:!0,hostAttributes:!0,properties:!0,observers:!0},Sc),Ed=Dd(HTMLElement),Vb=D(b=>{class a extends b{_shouldPropertyChange(c,d,e){return Db(this,c,d,e,!0)}}return a}),Fd=D(b=>{class a extends b{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(c,d,e){return Db(this,c,d,e,this.mutableData)}}return a});Vb._mutablePropertyChange=Db;let Fb=null;Eb.prototype=Object.create(HTMLTemplateElement.prototype,
{constructor:{value:Eb,writable:!0}});const Vc=Xa(Eb),Xe=Vb(Vc),If=Xa(class{});class Gb extends If{constructor(b){super();this._configureProperties(b);this.root=this._stampTemplate(this.__dataHost);var a=[];this.children=a;for(let c=this.root.firstChild;c;c=c.nextSibling)a.push(c),c.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);a=this.__templatizeOptions;(b&&a.instanceProps||!a.instanceProps)&&this._enableProperties()}_configureProperties(b){if(this.__templatizeOptions.forwardHostProp)for(let a in this.__hostProps)this._setPendingProperty(a,
this.__dataHost["_host_"+a]);for(let a in b)this._setPendingProperty(a,b[a])}forwardHostProp(b,a){this._setPendingPropertyOrPath(b,a,!1,!0)&&this.__dataHost._enqueueClient(this)}_addEventListenerToNode(b,a,c){if(this._methodHost&&this.__templatizeOptions.parentModel)this._methodHost._addEventListenerToNode(b,a,d=>{d.model=this;c(d)});else{let d=this.__dataHost.__dataHost;d&&d._addEventListenerToNode(b,a,c)}}_showHideChildren(b){Tc(b,this.children)}_setUnmanagedPropertyToNode(b,a,c){b.__hideTemplateChildren__&&
b.nodeType==Node.TEXT_NODE&&"textContent"==a?b.__polymerTextContent__=c:super._setUnmanagedPropertyToNode(b,a,c)}get parentModel(){let b=this.__parentModel;if(!b){let a;b=this;do b=b.__dataHost.__dataHost;while((a=b.__templatizeOptions)&&!a.parentModel);this.__parentModel=b}return b}dispatchEvent(b){return!0}}const We=Vb(Gb);let Xc=!1;const Jf=Da(Fd(Xa(HTMLElement)));class Kf extends Jf{static get observedAttributes(){return["mutable-data"]}constructor(){super();if(ca)throw Error("strictTemplatePolicy: dom-bind not allowed");
...
b.indexOf(a[c])&&this.__debounceRender(this.__render,this.delay)}}__itemsChanged(b){this.items&&!Array.isArray(this.items)&&console.warn("dom-repeat expected array for `items`, found",this.items);this.__handleItemPath(b.path,b.value)||("items"===b.path&&(this.__itemsArrayChanged=!0),this.__debounceRender(this.__render))}__debounceRender(b,a=0){this.__renderDebouncer=v.debounce(this.__renderDebouncer,0<a?G.after(a):F,b.bind(this));U.add(this.__renderDebouncer)}render(){this.__debounceRender(this.__render);
...
this.__teardownInstance();this._showHideChildren();Jb&&!this.notifyDomChange||this.if==this._lastIf||(this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0})),this._lastIf=this.if)}__hasInstance(){}__getInstanceNodes(){}__createAndInsertInstance(b){}__teardownInstance(){}_showHideChildren(){}}class Mf extends Hd{constructor(){super();this.__syncInfo=this.__instance=null}__hasInstance(){return!!this.__instance}__getInstanceNodes(){return this.__instance.templateInfo.childNodes}__createAndInsertInstance(b){const a=
...
!this.if;this.__instance&&!!this.__instance.__hidden!==b&&(this.__instance.__hidden=b,this.__instance._showHideChildren(b));b||this.__syncHostProperties()}}const Id=$c?Mf:Nf;customElements.define(Id.is,Id);let Of=D(b=>{b=Ya(b);class a extends b{static get properties(){return{items:{type:Array},multi:{type:Boolean,value:!1},selected:{type:Object,notify:!0},selectedItem:{type:Object,notify:!0},toggle:{type:Boolean,value:!1}}}static get observers(){return["__updateSelection(multi, items.*)"]}constructor(){super();
this.__selectedMap=this.__lastMulti=this.__lastItems=null}__updateSelection(c,d){var e=d.path;"items"==e?(d=d.base||[],e=this.__lastItems,c!==this.__lastMulti&&this.clearSelection(),e&&(e=Mc(d,0,d.length,e,0,e.length),this.__applySplices(e)),this.__lastItems=d,this.__lastMulti=c):"items.splices"==d.path?this.__applySplices(d.value.indexSplices):(c=e.slice(6),d=parseInt(c,10),0>c.indexOf(".")&&c==d&&this.__deselectChangedIdx(d))}__applySplices(c){let d=this.__selectedMap;for(let f=0;f<c.length;f++){let g=
...
this.__selectedMap.clear(),this.__selectedMap.set(d,c),this.__updateLinks(),this.multi?this.push("selected",d):this.selected=this.selectedItem=d)}}return a})(M);class Jd extends Of{static get is(){return"array-selector"}static get template(){return null}}customElements.define(Jd.is,Jd);const ja=Dd(HTMLElement).prototype;var ab=new Set;const Pf={properties:{_parentResizable:{type:Object,observer:"_parentResizableChanged"},_notifyingDescendant:{type:Boolean,value:!1}},listeners:{"iron-request-resize-notifications":"_onIronRequestResizeNotifications"},
created:function(){this._interestedResizables=[];this._boundNotifyResize=this.notifyResize.bind(this);this._boundOnDescendantIronResize=this._onDescendantIronResize.bind(this)},attached:function(){this._requestResizeNotifications()},detached:function(){this._parentResizable?this._parentResizable.stopResizeNotificationsFor(this):(ab.delete(this),window.removeEventListener("resize",this._boundNotifyResize));this._parentResizable=null},notifyResize:function(){this.isAttached&&(this._interestedResizables.forEach(function(b){this.resizerShouldNotify(b)&&
...
b()})}else this._findParent(),this._parentResizable?this._parentResizable._interestedResizables.forEach(function(a){a!==this&&a._findParent()},this):(ab.forEach(function(a){a!==this&&a._findParent()},this),window.addEventListener("resize",this._boundNotifyResize),this.notifyResize())},_findParent:function(){this.assignParentResizable(null);this.fire("iron-request-resize-notifications",null,{node:this,bubbles:!0,cancelable:!0});this._parentResizable?ab.delete(this):ab.add(this)}},Qf={properties:{scrollTarget:{type:HTMLElement,
...
(a.removeEventListener("scroll",this._boundScrollHandler),this._boundScrollHandler=null)},toggleScrollListener:function(b){this._shouldHaveListener=b;this._toggleScrollListener(b,this.scrollTarget)}};var Kd=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Rf=Kd&&8<=Kd[1],Ld=F;const Sf=function(b,a){b||console.warn("Polymer.Class requires `info` argument");a=a?a(Ed):Ed;a=Re(b,a,b.behaviors);a.is=a.prototype.is=b.is;return a}({behaviors:[Pf,Qf],_ratio:.5,_scrollerPaddingTop:0,_scrollPosition:0,
...
loading:{type:Boolean,notify:!0,readOnly:!0,reflectToAttribute:!0},_cache:{type:Object,value:function(){return new Md(this)}},itemIdPath:{type:String,value:null},expandedItems:{type:Object,notify:!0,value:()=>[]}}}static get observers(){return["_sizeChanged(size)","_itemIdPathChanged(itemIdPath)","_expandedItemsChanged(expandedItems.*)"]}_sizeChanged(a){a-=this._cache.size;this._cache.size+=a;this._cache.effectiveSize+=a;this._effectiveSize=this._cache.effectiveSize;this._increasePoolIfNeeded(0);
this._debounceIncreasePool&&this._debounceIncreasePool.flush()}_getItem(a,c){if(!(a>=this._effectiveSize)){c.index=a;var {cache:d,scaledIndex:e}=this._cache.getCacheAndIndex(a);(a=d.items[e])?(this._toggleAttribute("loading",!1,c),this._updateItem(c,a),this._isExpanded(a)&&d.ensureSubCacheForScaledIndex(e)):(this._toggleAttribute("loading",!0,c),this._loadPage(this._getPageForIndex(e),d))}}_expandedInstanceChangedCallback(a,c){void 0!==a.item&&(c?this.expandItem(a.item):this.collapseItem(a.item))}getItemId(a){return this.itemIdPath?
this.get(this.itemIdPath,a):a}_isExpanded(a){return this.__expandedKeys.has(this.getItemId(a))}_expandedItemsChanged(a){this.__cacheExpandedKeys();this._cache.updateSize();this._effectiveSize=this._cache.effectiveSize;this._assignModels()}_itemIdPathChanged(a){this.__cacheExpandedKeys()}__cacheExpandedKeys(){this.expandedItems&&(this.__expandedKeys=new Set,this.expandedItems.forEach(a=>{this.__expandedKeys.add(this.getItemId(a))}))}expandItem(a){this._isExpanded(a)||this.push("expandedItems",a)}collapseItem(a){this._isExpanded(a)&&
this.splice("expandedItems",this._getItemIndexInArray(a,this.expandedItems),1)}_getIndexLevel(a){({cache:a}=this._cache.getCacheAndIndex(a));let c=0;for(;a.parentCache;)a=a.parentCache,c++;return c}_canPopulate(){return!(!this._hasData||!this._columnTree)}_loadPage(a,c){if(!c.pendingRequests[a]&&this.dataProvider){this._setLoading(!0);c.pendingRequests[a]=!0;const d={page:a,pageSize:this.pageSize,sortOrders:this._mapSorters(),filters:this._mapFilters(),parentItem:c.parentItem};this.dataProvider(d,
(e,f)=>{void 0!==f?c.size=f:d.parentItem&&(c.size=e.length);const g=Array.from(this.$.items.children).map(h=>h._item);e.forEach((h,k)=>{k=a*this.pageSize+k;c.items[k]=h;this._isExpanded(h)&&-1<g.indexOf(h)&&c.ensureSubCacheForScaledIndex(k)});this._hasData=!0;delete c.pendingRequests[a];this._debouncerApplyCachedData=v.debounce(this._debouncerApplyCachedData,G.after(0),()=>{this._setLoading(!1);this._cache.updateSize();this._effectiveSize=this._cache.effectiveSize;Array.from(this.$.items.children).filter(h=>
!h.hidden).forEach(h=>{this._cache.getItemForIndex(h.index)&&this._getItem(h.index,h)});this._increasePoolIfNeeded(0);this.__scrollToPendingIndex()});this._cache.isLoading()||this._debouncerApplyCachedData.flush();this.__itemsReceived()})}}_getPageForIndex(a){return Math.floor(a/this.pageSize)}clearCache(){this._cache=new Md(this);Array.from(this.$.items.children).forEach(a=>{Array.from(a.children).forEach(c=>{c._instance&&c._instance._setPendingProperty("item",{},!1)})});this._cache.size=this.size||
0;this._cache.updateSize();this._hasData=!1;this._assignModels();this._effectiveSize||this._loadPage(0,this._cache)}_pageSizeChanged(a,c){void 0!==c&&a!==c&&this.clearCache()}_checkSize(){void 0===this.size&&0===this._effectiveSize&&console.warn("The \x3cvaadin-grid\x3e needs the total number of items in order to display rows. Set the total number of items to the `size` property, or provide the total number of items in the second argument of the `dataProvider`\u2019s `callback` call.")}_dataProviderChanged(a,
...
const f=a.slice(5);this._grid.notifyPath(`items.${e}.${f}`,c)}e=`_${a}InstanceChangedCallback`;if(this._grid&&this._grid[e])this._grid[e](b,c)}}}}))}_forwardParentProp(b,a){this._parentPathValues[b]=a;this._templateInstances.forEach(c=>c.notifyPath(b,a))}_templateInstancesChanged(b,a){let c,d;if("_templateInstances"===b.path)c=0,d=this._templateInstances.length;else if("_templateInstances.splices"===b.path)c=b.value.index,d=b.value.addedCount;else return;Object.keys(this._parentPathValues||{}).forEach(e=>
{for(var f=c;f<c+d;f++)this._templateInstances[f].set(e,this._parentPathValues[e])})}}customElements.define(bb.is,bb);const bg=b=>class extends b{static get properties(){return{detailsOpenedItems:{type:Array,value:function(){return[]}},_rowDetailsTemplate:Object,rowDetailsRenderer:Function,_detailsCells:{type:Array}}}static get observers(){return["_detailsOpenedItemsChanged(detailsOpenedItems.*, _rowDetailsTemplate, rowDetailsRenderer)","_rowDetailsTemplateOrRendererChanged(_rowDetailsTemplate, rowDetailsRenderer)"]}_rowDetailsTemplateOrRendererChanged(a,
c){if(a&&c)throw Error("You should only use either a renderer or a template for row details");if(a||c)a&&!a.templatizer&&(c=new bb,c._grid=this,c.dataHost=this.dataHost,c.template=a,a.templatizer=c),this._columnTree&&Array.from(this.$.items.children).forEach(d=>{d.querySelector("[part~\x3ddetails-cell]")||(this._updateRow(d,this._columnTree[this._columnTree.length-1]),this._a11yUpdateRowDetailsOpened(d,!1));delete d.querySelector("[part~\x3ddetails-cell]")._instance}),this.detailsOpenedItems.length&&
(Array.from(this.$.items.children).forEach(this._toggleDetailsCell,this),this._update())}_detailsOpenedItemsChanged(a,c,d){"detailsOpenedItems.length"!==a.path&&a.value&&Array.from(this.$.items.children).forEach(e=>{this._toggleDetailsCell(e,e._item);this._a11yUpdateRowDetailsOpened(e,this._isDetailsOpened(e._item));this._toggleAttribute("details-opened",this._isDetailsOpened(e._item),e)})}_configureDetailsCell(a){a.setAttribute("part","cell details-cell");this._toggleAttribute("frozen",!0,a)}_toggleDetailsCell(a,
...
this._updateItem(a,c)),ea(),a.style.setProperty("padding-bottom",`${d.offsetHeight}px`),requestAnimationFrame(()=>this.notifyResize()));f&&(this._updateMetrics(),this._positionItems())}}_updateDetailsCellHeights(){Array.from(this.$.items.querySelectorAll('[part~\x3d"details-cell"]:not([hidden])')).forEach(a=>{a.parentElement.style.setProperty("padding-bottom",`${a.offsetHeight}px`)})}_isDetailsOpened(a){return this.detailsOpenedItems&&-1!==this._getItemIndexInArray(a,this.detailsOpenedItems)}openItemDetails(a){this._isDetailsOpened(a)||
this.push("detailsOpenedItems",a)}closeItemDetails(a){this._isDetailsOpened(a)&&this.splice("detailsOpenedItems",this._getItemIndexInArray(a,this.detailsOpenedItems),1)}_detailsOpenedInstanceChangedCallback(a,c){super._detailsOpenedInstanceChangedCallback&&super._detailsOpenedInstanceChangedCallback(a,c);c?this.openItemDetails(a.item):this.closeItemDetails(a.item)}},cg=b=>class extends b{get _timeouts(){return{SCROLLING:500,IGNORE_WHEEL:500}}static get properties(){return{_frozenCells:{type:Array,
value:()=>[]},_rowWithFocusedElement:Element,_deltaYAcc:{type:Number,value:0},_useSticky:{type:Boolean,value:window.CSS&&window.CSS.supports&&(window.CSS.supports("position","sticky")||window.CSS.supports("position","-webkit-sticky"))}}}static get observers(){return["_scrollViewportHeightUpdated(_viewportHeight)"]}set _scrollTop(a){this.$.table.scrollTop=a}get _scrollTop(){return this.$.table.scrollTop}constructor(){super();this._scrollLineHeight=this._getScrollLineHeight()}_getScrollLineHeight(){const a=
document.createElement("div");a.style.fontSize="initial";a.style.display="none";document.body.appendChild(a);const c=window.getComputedStyle(a).fontSize;document.body.removeChild(a);return c?window.parseInt(c):void 0}_scrollViewportHeightUpdated(a){this._scrollPageHeight=a-this.$.header.clientHeight-this.$.footer.clientHeight-this._scrollLineHeight}ready(){super.ready();this.$.outerscroller=document.createElement("div");this.scrollTarget=this.$.table;this.addEventListener("wheel",this._onWheel);this.$.items.addEventListener("focusin",
a=>{const c=a.composedPath().indexOf(this.$.items);this._rowWithFocusedElement=a.composedPath()[c-1]});this.$.items.addEventListener("focusout",()=>this._rowWithFocusedElement=void 0);this.scrollTarget.addEventListener("mousedown",()=>this.__mouseDown=!0);this.scrollTarget.addEventListener("mouseup",()=>{this.__mouseDown=!1;this.__pendingReorder&&(this.__pendingReorder=!1,setTimeout(()=>this._reorderRows(),this._timeouts.SCROLLING))})}scrollToIndex(a){this._accessIronListAPI(()=>super.scrollToIndex(a))}_onWheel(a){if(!a.ctrlKey&&
!this._hasScrolledAncestor(a.target,a.deltaX,a.deltaY)){var c=this.$.table,d=a.deltaY;a.deltaMode===WheelEvent.DOM_DELTA_LINE?d*=this._scrollLineHeight:a.deltaMode===WheelEvent.DOM_DELTA_PAGE&&(d*=this._scrollPageHeight);if(this._wheelAnimationFrame)this._deltaYAcc+=d,a.preventDefault();else{d+=this._deltaYAcc;this._deltaYAcc=0;this._wheelAnimationFrame=!0;this._debouncerWheelAnimationFrame=v.debounce(this._debouncerWheelAnimationFrame,L,()=>this._wheelAnimationFrame=!1);var e=Math.abs(a.deltaX)+
Math.abs(d);this._canScroll(c,a.deltaX,d)?(a.preventDefault(),c.scrollTop+=d,c.scrollLeft+=a.deltaX,this._scrollHandler(),this._ignoreNewWheel=this._hasResidualMomentum=!0,this._debouncerIgnoreNewWheel=v.debounce(this._debouncerIgnoreNewWheel,G.after(this._timeouts.IGNORE_WHEEL),()=>this._ignoreNewWheel=!1)):this._hasResidualMomentum&&e<=this._previousMomentum||this._ignoreNewWheel?a.preventDefault():e>this._previousMomentum&&(this._hasResidualMomentum=!1);this._previousMomentum=e}}}_hasScrolledAncestor(a,
c,d){if("vaadin-grid-cell-content"===a.localName)return!1;if(this._canScroll(a,c,d)&&-1!==["auto","scroll"].indexOf(getComputedStyle(a).overflow))return!0;if(a!==this&&a.parentElement)return this._hasScrolledAncestor(a.parentElement,c,d)}_canScroll(a,c,d){return 0<d&&a.scrollTop<a.scrollHeight-a.offsetHeight||0>d&&0<a.scrollTop||0<c&&a.scrollLeft<a.scrollWidth-a.offsetWidth||0>c&&0<a.scrollLeft}_scheduleScrolling(){this._scrollingFrame||(this._scrollingFrame=requestAnimationFrame(()=>this._toggleAttribute("scrolling",
!0,this.$.scroller)));this._debounceScrolling=v.debounce(this._debounceScrolling,G.after(this._timeouts.SCROLLING),()=>{cancelAnimationFrame(this._scrollingFrame);delete this._scrollingFrame;this._toggleAttribute("scrolling",!1,this.$.scroller);this._reorderRows()})}_afterScroll(){this._translateStationaryElements();this.hasAttribute("reordering")||this._scheduleScrolling();this._updateOverflow()}_updateOverflow(){let a="";const c=this.$.table;c.scrollTop<c.scrollHeight-c.clientHeight&&(a+=" bottom");
0<c.scrollTop&&(a+=" top");c.scrollLeft<c.scrollWidth-c.clientWidth&&(a+=" right");0<c.scrollLeft&&(a+=" left");this._debounceOverflow=v.debounce(this._debounceOverflow,L,()=>{const d=a.trim();0<d.length&&this.getAttribute("overflow")!==d?this.setAttribute("overflow",d):0==d.length&&this.hasAttribute("overflow")&&this.removeAttribute("overflow")})}_reorderRows(){if(this.__mouseDown)this.__pendingReorder=!0;else{var a=this.$.items,c=a.querySelectorAll("tr");if(c.length){var d=this._virtualStart+this._vidxOffset,
e=this._rowWithFocusedElement||Array.from(c).filter(f=>!f.hidden)[0];if(e){d=e.index-d;e=Array.from(c).indexOf(e)-d;if(0<e)for(d=0;d<e;d++)a.appendChild(c[d]);else if(0>e)for(e=c.length+e;e<c.length;e++)a.insertBefore(c[e],c[0]);if(this._safari){const {transform:f}=this.$.header.style;this.$.header.style.transform="";setTimeout(()=>this.$.header.style.transform=f)}}}}}_frozenCellsChanged(){this._debouncerCacheElements=v.debounce(this._debouncerCacheElements,F,()=>{Array.from(this.shadowRoot.querySelectorAll('[part~\x3d"cell"]')).forEach(function(a){a.style.transform=
""});this._frozenCells=Array.prototype.slice.call(this.$.table.querySelectorAll("[frozen]"));this._updateScrollerMeasurements();this._translateStationaryElements()});this._updateLastFrozen()}_updateScrollerMeasurements(){0<this._frozenCells.length&&this.__isRTL&&(this.__scrollerMetrics={scrollWidth:this.$.table.scrollWidth,clientWidth:this.$.table.clientWidth})}_updateLastFrozen(){if(this._columnTree){var a=this._columnTree[this._columnTree.length-1].slice(0);a.sort((d,e)=>d._order-e._order);var c=
a.reduce((d,e,f)=>{e._lastFrozen=!1;return e.frozen&&!e.hidden?f:d},void 0);void 0!==c&&(a[c]._lastFrozen=!0)}}_translateStationaryElements(){var a=Math.max(0,this._scrollLeft),c=Math.max(0,this._scrollTop);let d=0,e=0,f=0;this._useSticky||(d=a,e=c,f=this.$.table.clientHeight-this.$.footer.offsetHeight-this.$.footer.offsetTop);this.$.header.style.transform=this._getTranslate(-a+d,e);this.$.footer.style.transform=this._getTranslate(-a+d,e+f);this.$.items.style.transform=this._getTranslate(-a+d,0);
if(0<this._frozenCells.length)for(a=this.__isRTL?this.__getNormalizedScrollLeft(this.$.table)+this.__scrollerMetrics.clientWidth-this.__scrollerMetrics.scrollWidth:this._scrollLeft,a=this._getTranslate(a,0),c=0;c<this._frozenCells.length;c++)this._frozenCells[c].style.transform=a}_getTranslate(a,c){return`translate(${a}px, ${c}px)`}},dg=b=>class extends b{static get properties(){return{selectedItems:{type:Object,notify:!0,value:()=>[]}}}static get observers(){return["_selectedItemsChanged(selectedItems.*)"]}_isSelected(a){return this.selectedItems&&
...
c._item)})}_selectedInstanceChangedCallback(a,c){super._selectedInstanceChangedCallback&&super._selectedInstanceChangedCallback(a,c);c?this.selectItem(a.item):this.deselectItem(a.item)}},eg=b=>class extends b{static get properties(){return{multiSort:{type:Boolean,value:!1},_sorters:{type:Array,value:function(){return[]}},_previousSorters:{type:Array,value:function(){return[]}}}}ready(){super.ready();this.addEventListener("sorter-changed",this._onSorterChanged);window.ShadyDOM&&F.run(()=>{const a=
this.querySelectorAll("vaadin-grid-sorter");Array.from(a).forEach(c=>{c instanceof M&&c.dispatchEvent(new CustomEvent("sorter-changed",{bubbles:!0,composed:!0}))})})}_onSorterChanged(a){const c=a.target;this._removeArrayItem(this._sorters,c);c._order=null;this.multiSort?(c.direction&&this._sorters.unshift(c),this._sorters.forEach((d,e)=>d._order=1<this._sorters.length?e:null,this)):c.direction&&(this._sorters.forEach(d=>{d._order=null;d.direction=null}),this._sorters=[c]);a.stopPropagation();this.dataProvider&&
...
"Interaction";break;case "Tab":d="Tab";break;case " ":d="Space"}this._detectInteracting(a);this.hasAttribute("interacting")&&"Interaction"!==d&&(d=void 0);if(d)this[`_on${d}KeyDown`](a,c)}_ensureScrolledToIndex(a){Array.from(this.$.items.children).filter(c=>c.index===a)[0]||this._scrollToIndex(a)}_onNavigationKeyDown(a,c){this._scrollHandler();a.preventDefault();var d=this._lastVisibleIndex-this._firstVisibleIndex-1,e=0,f=0;switch(c){case "ArrowRight":e=this.__isRTL?-1:1;break;case "ArrowLeft":e=
this.__isRTL?1:-1;break;case "Home":e=-Infinity;a.ctrlKey&&(f=-Infinity);break;case "End":e=Infinity;a.ctrlKey&&(f=Infinity);break;case "ArrowDown":f=1;break;case "ArrowUp":f=-1;break;case "PageDown":f=d;break;case "PageUp":f=-d}a=a.composedPath()[0];var g=Array.prototype.indexOf.call(a.parentNode.children,a);c=this._elementMatches(a,'[part~\x3d"details-cell"]');var h=a.parentNode;a=h.parentNode;var k=(a===this.$.items?this._effectiveSize:a.children.length)-1,l=a===this.$.items?void 0!==this._focusedItemIndex?
this._focusedItemIndex:h.index:Array.prototype.indexOf.call(h.parentNode.children,h);let m=Math.max(0,Math.min(l+f,k));d=!1;a===this.$.items&&(d=h._item,h=this._cache.getItemForIndex(m),d=c?0===f:1===f&&this._isDetailsOpened(d)||-1===f&&m!==l&&this._isDetailsOpened(h),d!==c&&(1===f&&d||-1===f&&!d)&&(m=l));if(a!==this.$.items)if(m>l)for(;m<k&&a.children[m].hidden;)m++;else if(m<l)for(;0<m&&a.children[m].hidden;)m--;void 0===this._focusedColumnOrder&&(this._focusedColumnOrder=c?0:this._getColumns(a,
l).filter(n=>!n.hidden)[g]._order);g=this._getColumns(a,m).filter(n=>!n.hidden);k=g.map(n=>n._order).sort((n,p)=>n-p);h=k.length-1;l=k.indexOf(k.slice(0).sort((n,p)=>Math.abs(n-this._focusedColumnOrder)-Math.abs(p-this._focusedColumnOrder))[0]);e=0===f&&c?l:Math.max(0,Math.min(l+e,h));e!==l&&(this._focusedColumnOrder=void 0);a===this.$.items&&this._ensureScrolledToIndex(m);this._toggleAttribute("navigating",!0,this);e=g.reduce((n,p,r)=>(n[p._order]=r,n),{})[k[e]];if(f=a===this.$.items?Array.from(a.children).filter(n=>
n.index===m)[0]:a.children[m])e=d?Array.from(f.children).filter(n=>this._elementMatches(n,'[part~\x3d"details-cell"]'))[0]:f.children[e],this._scrollHorizontallyToCell(e),a===this.$.items&&(this._focusedItemIndex=m),a===this.$.items&&(f=e.getBoundingClientRect(),a=this.$.footer.getBoundingClientRect().top,c=this.$.header.getBoundingClientRect().bottom,f.bottom>a?(this.$.table.scrollTop+=f.bottom-a,this._scrollHandler()):f.top<c&&(this.$.table.scrollTop-=c-f.top,this._scrollHandler())),e.focus()}_parseEventPath(a){const c=
...
this._previousHidden=a}};class cb extends jg(Rb(M)){static get is(){return"vaadin-grid-column"}static get properties(){return{width:{type:String,value:"100px"},flexGrow:{type:Number,value:1},renderer:Function,path:{type:String},autoWidth:{type:Boolean,value:!1},_bodyTemplate:{type:Object},_cells:Array}}}customElements.define(cb.is,cb);const Nd=document.createElement("dom-module");Nd.appendChild(K`
  <style>
...
`);Nd.register("vaadin-grid-styles");try{document.createEvent("TouchEvent");var Od=!0}catch(b){Od=!1}const kg=Od;class Pd extends wd(Nb(Yf(Wf(Zf(Vf(cg(dg(eg(bg(hg(Tf(ag(ig(Xf($f(gg(fg(Wb)))))))))))))))))){static get template(){return K`
...
_ie:{type:Boolean,value:!(!navigator.userAgent.match(/Trident/)||navigator.userAgent.match(/MSIE/))},_firefox:{type:Boolean,value:-1<navigator.userAgent.toLowerCase().indexOf("firefox")},_android:{type:Boolean,value:/android/i.test(navigator.userAgent)},_touchDevice:{type:Boolean,value:kg},heightByRows:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_heightByRowsChanged"},_recalculateColumnWidthOnceLoadingFinished:{type:Boolean,value:!0}}}constructor(){super();this.addEventListener("animationend",
this._onAnimationEnd)}connectedCallback(){super.connectedCallback();this.recalculateColumnWidths()}attributeChangedCallback(b,a,c){super.attributeChangedCallback(b,a,c);"dir"===b&&(this.__isRTL="rtl"===c,this._updateScrollerMeasurements())}__hasRowsWithClientHeight(){return!!Array.from(this.$.items.children).filter(b=>b.clientHeight).length}__itemsReceived(){this._recalculateColumnWidthOnceLoadingFinished&&!this._cache.isLoading()&&this.__hasRowsWithClientHeight()&&(this._recalculateColumnWidthOnceLoadingFinished=
!1,this.recalculateColumnWidths())}_recalculateColumnWidths(b){b.forEach(a=>{a.width="auto";a._origFlexGrow=a.flexGrow;a.flexGrow=0});b.forEach(a=>{a._currentWidth=0;a._allCells.forEach(c=>{a._currentWidth=Math.max(a._currentWidth,c.offsetWidth+1)})});b.forEach(a=>{a.width=`${a._currentWidth}px`;a.flexGrow=a._origFlexGrow;a._currentWidth=void 0;a._origFlexGrow=void 0})}recalculateColumnWidths(){if(this._columnTree)if(this._cache.isLoading())this._recalculateColumnWidthOnceLoadingFinished=!0;else{const b=
this._getColumns().filter(a=>!a.hidden&&a.autoWidth);this._recalculateColumnWidths(b)}}_createScrollerRows(b){const a=[];for(var c=0;c<b;c++){const d=document.createElement("tr");d.setAttribute("part","row");d.setAttribute("role","row");this._columnTree&&this._updateRow(d,this._columnTree[this._columnTree.length-1],"body",!1,!0);a.push(d)}this._columnTree&&this._columnTree[this._columnTree.length-1].forEach(d=>d.notifyPath&&d.notifyPath("_cells.*",d._cells));Ke(this,()=>{this._updateFirstAndLastColumn();
...
1));Array.from(this.$.footer.children).forEach((c,d)=>this._updateRow(c,b[b.length-1-d],"footer",0===d));this._updateRow(this.$.sizer,b[b.length-1]);this._resizeHandler();this._frozenCellsChanged();this._updateFirstAndLastColumn();this._resetKeyboardNavigation();this._a11yUpdateHeaderRows();this._a11yUpdateFooterRows();this.__updateFooterPositioning()}__updateFooterPositioning(){this._firefox&&(this.$.items.style.paddingBottom=0,this.heightByRows||(this.$.items.style.paddingBottom=`${this.$.footer.offsetHeight}px`));
this._ios&&!window.CSS.supports("position","sticky")&&(this.$.table.style.height="",this.$.table.style.minHeight="100%",this.$.table.style.maxHeight="100%",setTimeout(()=>this.$.table.style.height=`${this.$.scroller.offsetHeight}px`))}_updateItem(b,a){b._item=a;const c=this.__getRowModel(b);this._toggleAttribute("selected",c.selected,b);this._a11yUpdateRowSelected(b,c.selected);this._a11yUpdateRowLevel(b,c.level);this._toggleAttribute("expanded",c.expanded,b);(this._rowDetailsTemplate||this.rowDetailsRenderer)&&
this._toggleDetailsCell(b,a);this._generateCellClassNames(b,c);this._filterDragAndDrop(b,c);Array.from(b.children).forEach(d=>{if(d._renderer){const e=d._column||this;d._renderer.call(e,d._content,e,c)}else d._instance&&(d._instance.__detailsOpened__=c.detailsOpened,d._instance.__selected__=c.selected,d._instance.__level__=c.level,d._instance.__expanded__=c.expanded,d._instance.setProperties(c))});this._debouncerUpdateHeights=v.debounce(this._debouncerUpdateHeights,G.after(1),()=>{this._updateMetrics();
this._positionItems();this._updateScrollerSize()})}_resizeHandler(){this._updateDetailsCellHeights();this._accessIronListAPI(super._resizeHandler,!0);this._updateScrollerMeasurements();this.__updateFooterPositioning()}_onAnimationEnd(b){0===b.animationName.indexOf("vaadin-grid-appear")&&(this._render(),b.stopPropagation(),this.notifyResize(),this.__itemsReceived(),requestAnimationFrame(()=>{this.__scrollToPendingIndex();this.$.table.style.webkitOverflowScrolling="touch"}))}_toggleAttribute(b,a,c){c.hasAttribute(b)===
!a&&(a?c.setAttribute(b,""):c.removeAttribute(b))}__getRowModel(b){return{index:b.index,item:b._item,level:this._getIndexLevel(b.index),expanded:this._isExpanded(b._item),selected:this._isSelected(b._item),detailsOpened:!(!this._rowDetailsTemplate&&!this.rowDetailsRenderer)&&this._isDetailsOpened(b._item)}}render(){this._columnTree&&(this._columnTree.forEach(b=>{b.forEach(a=>a._renderHeaderAndFooter())}),this._update())}notifyResize(){super.notifyResize()}_heightByRowsChanged(b,a){(b||a)&&this.notifyResize()}__forceReflow(){this._debouncerForceReflow=
v.debounce(this._debouncerForceReflow,L,()=>{this.$.scroller.style.overflow="hidden";setTimeout(()=>this.$.scroller.style.overflow="")})}}customElements.define(Pd.is,Pd);class Qd extends cb{static get template(){return K`
...
a&&/^((?!chrome|android).)*safari/i.test(navigator.userAgent)&&this.root&&this.root.querySelectorAll("*").forEach(function(c){c.style["-webkit-backface-visibility"]="visible";c.style["-webkit-backface-visibility"]=""})}}customElements.define(Sd.is,Sd);class Td extends cb{static get template(){return K`
    <template class="header" id="headerTemplate">
      <vaadin-grid-sorter path="[[path]]" direction="{{direction}}">[[_getHeader(header, path)]]</vaadin-grid-sorter>
    </template>
`}static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}_prepareHeaderTemplate(){const b=this._prepareTemplatizer(this.$.headerTemplate);b.templatizer.dataHost=this;return b}_getHeader(b,a){return b||this._generateHeader(a)}}customElements.define(Td.is,Td);const Ud={selectionColumn:!0};let w=function(b){function a(d,e){d=b.call(this,d,e)||this;d._grid=null;d._headerStyles="display: flex; font-weight: 400;";d._hostStyles='font-family: "Avenir Next", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 1em; background-color: inherit; color: inherit;';
d._rowHoverStyles="background-color: var(--lumo-row-background-hover);";d._columnElements=[];d.cellClassNameGenerator=null;d.columnReorderingEnabled=!0;d.dataProvider=null;d.itemIdPath=null;d.label=void 0;d.messages=null;d.pageSize=50;d.selectedItems=new Zd;d.size=null;d.rowDetailsRenderer=null;d.store=null;d.viewModel=new de;d.visibleElements={...Ud};return d}Vd._inheritsLoose(a,b);var c=a.prototype;c.initialize=function(){this.handles.add([this.columns.on("change",()=>this._syncColumnRenderers()),
db.watch(this,"viewModel.size",()=>this._updateGridSize()),db.watch(this,"store.state",(d,e)=>{"ready"===d&&"loaded"===e&&this.refreshCache()}),db.on(this,"_grid.$.table","scroll",()=>{var d;null==(d=this.viewModel)?void 0:d.closeColumnMenus()})])};c.destroy=function(){var d;this.handles.removeAll();this.resetColumns();null==(d=this.columns)?void 0:d.destroy()};c.resetColumns=function(){this.columns.items.forEach(d=>d.destroy());this.columns.removeAll()};c.castVisibleElements=function(d){return{...Ud,
...d}};c.render=function(){return ka.jsx("div",{bind:this,class:this.classes("esri-grid","esri-widget")},ka.jsx("div",{bind:this,class:"esri-grid__content"},this.renderGrid()))};c.renderGrid=function(){return ka.jsx("vaadin-grid",Object.assign({},this.getGridProps()),this.renderAllColumns())};c.renderAllColumns=function(){if("disabled"!==this.viewModel.state&&this.columns&&this.columns.length)return[this.renderSelectionColumn(),this.renderColumns()]};c.renderSelectionColumn=function(){return ka.jsx("vaadin-grid-selection-column",
{_selectAllHidden:!0,selectAll:!1,bind:this,hidden:!this.visibleElements.selectionColumn,sortable:!1,frozen:!ae.isRTL()})};c.renderColumns=function(){return this.columns.items.map((d,e)=>ka.jsx("vaadin-grid-column",Object.assign({},this.getColumnProps(d,e))))};c.getGridProps=function(){const {columnReorderingEnabled:d,id:e,pageSize:f,size:g}=this;return{_safari:!1,class:"esri-grid__grid",id:`${e}_grid`,theme:"compact column-borders",ref:"grid",bind:this,afterCreate:this._afterGridCreate,afterUpdate:this._afterGridUpdate,
columnReorderingAllowed:d,pageSize:f,size:g}};c.getColumnProps=function(d,e){const {id:f}=this,{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,path:p,resizable:r,textAlign:u,width:z}=d;d=`${f}_${name}_${Wd.isSome(e)?e:p}`;return{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,key:d,path:p,resizable:r,"text-align":u,width:"number"===typeof z?`${z}px`:z,bind:this,afterCreate:this._afterColumnCreate,afterRemoved:this._afterColumnRemoved}};c.clearSelection=function(){this._clearSelection();
