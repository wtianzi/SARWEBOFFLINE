...
function(e,c,n,p,f,g,q,d,r,h,t,u,v,w,x,y,z,A,B,C,D,E,F,G,k){function l(a){const b=new p.ShaderBuilder,H=b.vertex.code,m=b.fragment.code;b.vertex.uniforms.add("proj","mat4").add("view","mat4").add("camPos","vec3").add("localOrigin","vec3");b.include(B.PositionAttribute);b.varyings.add("vpos","vec3");b.include(q.VisualVariables,a);b.include(w.InstancedDoublePrecision,a);b.include(r.VerticalOffset,a);if(0===a.output||7===a.output)b.include(A.NormalAttribute,a),b.include(n.Transform,{linearDepth:!1}),
a.offsetBackfaces&&b.include(z.Offset),a.instancedColor&&b.attributes.add("instanceColor","vec4"),b.varyings.add("vNormalWorld","vec3"),b.varyings.add("localvpos","vec3"),a.multipassTerrainEnabled&&b.varyings.add("depth","float"),b.include(x.TextureCoordinateAttribute,a),b.include(u.ForwardLinearDepth,a),b.include(C.SymbolColor,a),b.include(D.VertexColor,a),b.vertex.uniforms.add("externalColor","vec4"),b.varyings.add("vcolorExt","vec4"),H.add(c.glsl`
        void main(void) {
...
a.hasColorTexture&&b.fragment.uniforms.add("tex","sampler2D"),b.include(y.PhysicallyBasedRenderingParameters,a),b.include(v.PhysicallyBasedRendering,a),b.fragment.include(k.MixExternalColor),m.add(c.glsl`
      void main() {
        discardBySlice(vpos);
        ${a.multipassTerrainEnabled?c.glsl`terrainDepthTest(gl_FragCoord, depth);`:""}
        ${a.hasColorTexture?c.glsl`
    ...
    `));b.include(E.DefaultMaterialAuxiliaryPasses,a);return b}var I=Object.freeze({__proto__:null,build:l});e.RealisticTreeShader=I;e.build=l});