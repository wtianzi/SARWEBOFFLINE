...
function(f,h,m,n,c,p,q,r,t,u,v,w,x,y,z,g){function l(b){const a=new p.ShaderBuilder;var d=b.signedDistanceFieldEnabled;a.include(r.AlignPixel);a.include(v.HUD,b);a.include(t.Slice,b);if(6===b.output)return a.include(x.HUDOcclusionPass,b),a;a.include(u.ScreenSizePerspective);a.fragment.include(w.RgbaFloatEncoding);a.fragment.include(q.ColorConversion);a.include(z.VisualVariables,b);a.varyings.add("vcolor","vec4");a.varyings.add("vtc","vec2");a.varyings.add("vsize","vec2");b.binaryHighlightOcclusionEnabled&&
...
a.attributes.add("auxpos2","vec4");a.vertex.code.add(c.glsl`
  ...
  `;7===b.output&&a.fragment.code.add(c.glsl`
    ...
    `);4===b.output&&(a.include(y.OutputHighlight),a.fragment.code.add(c.glsl`
    void main() {
      ${d}
