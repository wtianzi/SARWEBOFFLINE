...
//>>built
define("exports ../views/3d/webgl-engine/core/shaderModules/interfaces ../views/3d/webgl-engine/core/shaderModules/ShaderBuilder ../views/3d/webgl-engine/core/shaderLibrary/hud/AlignPixel.glsl ../views/3d/webgl-engine/core/shaderLibrary/Slice.glsl ../views/3d/webgl-engine/core/shaderLibrary/hud/HUD.glsl ../views/3d/webgl-engine/core/shaderLibrary/shading/MultipassGeometryTest.glsl".split(" "),function(e,c,k,l,m,n,p){function g(b){const a=new k.ShaderBuilder;a.include(l.AlignPixel);a.include(n.HUD,
b);a.include(m.Slice,b);a.attributes.add("uv0","vec2");a.vertex.uniforms.add("lineSize","float").add("pixelToNDC","vec2").add("borderSize","float").add("screenOffset","vec2");a.varyings.add("coverageSampling","vec4");a.varyings.add("lineSizes","vec2");b.multipassGeometryEnabled&&a.varyings.add("depth","float");a.vertex.code.add(c.glsl`
    void main(void) {
  ...
  `);a.fragment.uniforms.add("color","vec4");a.fragment.uniforms.add("borderColor","vec4");b.multipassGeometryEnabled&&(a.fragment.include(p.multipassGeometryTest,b),a.fragment.uniforms.add("inverseViewport","vec2"));a.fragment.code.add(c.glsl`
    void main() {
  ...
  `);return a}function h(b,a,d){3===d.length?b.setUniform4f(a,d[0],d[1],d[2],1):b.setUniform4fv(a,d)}(function(b){b.bindUniforms=function(a,d,f){h(a,"color",d.color);a.setUniform1f("pixelRatio",f);a.setUniform2f("screenOffset",d.screenOffset[0]*f,d.screenOffset[1]*f);null!==d.borderColor?(h(a,"borderColor",d.borderColor),a.setUniform1f("borderSize",f)):(a.setUniform4f("borderColor",0,0,0,0),a.setUniform1f("borderSize",0))}})(e.LineCallout||(e.LineCallout={}));var q=Object.freeze({__proto__:null,build:g,
get LineCallout(){return e.LineCallout}});e.LineCalloutShader=q;e.build=g});