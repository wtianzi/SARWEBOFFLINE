...
function(d,c,f,g,h,k,l,m,n){function e(b){const a=new g.ShaderBuilder;a.include(f.Transform,{linearDepth:!1});a.include(n.VertexColor,b);a.include(m.LineStipple,b);a.vertex.uniforms.add("proj","mat4").add("view","mat4");a.attributes.add("position","vec3");a.varyings.add("vpos","vec3");a.vertex.code.add(c.glsl`
    void main(void) {
      vpos = position;
