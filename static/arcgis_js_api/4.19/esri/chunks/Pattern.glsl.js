...
function(f,c,h,k,l,m,n,p,q,r,t,u){function g(b){const a=new k.ShaderBuilder;b.draped||a.extensions.add("GL_OES_standard_derivatives");const d=1===b.output;a.include(h.Transform,{linearDepth:d});a.include(u.VertexColor,b);a.vertex.uniforms.add("proj","mat4");a.vertex.uniforms.add("view","mat4");d&&(a.include(t.OutputDepth,b),a.vertex.uniforms.add("cameraNearFar","vec2"),a.varyings.add("linearDepth","float"));b.draped?a.vertex.uniforms.add("worldToScreenRatio","float"):(a.vertex.uniforms.add("worldToScreenPerDistanceRatio",
"float"),a.vertex.uniforms.add("camPos","vec3"),a.attributes.add("boundingRect","mat3"));a.attributes.add("position","vec3");a.attributes.add("uvMapSpace","vec4");a.varyings.add("vpos","vec3");a.varyings.add("vuv","vec2");b.multipassTerrainEnabled&&a.varyings.add("depth","float");const e=3===b.style||4===b.style||5===b.style;e&&a.vertex.code.add(c.glsl`
    ...
    `);b.draped||(a.vertex.code.add(c.glsl`
  ...
  `);a.include(m.Slice,b);a.fragment.include(l.ColorConversion);a.fragment.uniforms.add("matColor","vec4");b.draped&&a.fragment.uniforms.add("texelSize","float");4===b.output&&a.include(p.OutputHighlight);b.multipassTerrainEnabled&&(a.fragment.include(n.ReadLinearDepth),a.include(r.multipassTerrainTest,b));4!==b.output&&(a.fragment.code.add(c.glsl`
    ...
    `),b.draped||a.fragment.code.add(c.glsl`
