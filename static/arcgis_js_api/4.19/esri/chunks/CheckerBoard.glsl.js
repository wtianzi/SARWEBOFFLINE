...
//>>built
define("exports ../views/3d/webgl-engine/core/shaderModules/interfaces ../views/3d/webgl-engine/core/shaderModules/ShaderBuilder ../views/3d/webgl-engine/core/shaderLibrary/util/ColorConversion.glsl ../views/3d/webgl-engine/core/shaderLibrary/output/ReadLinearDepth.glsl ../views/3d/webgl-engine/core/shaderLibrary/shading/MultipassTerrainTest.glsl".split(" "),function(c,d,f,g,h,k){function e(b){const a=new f.ShaderBuilder;a.extensions.add("GL_OES_standard_derivatives");a.attributes.add("position",
"vec3");a.attributes.add("uv0","vec2");a.vertex.uniforms.add("proj","mat4").add("view","mat4");a.varyings.add("vUV","vec2");b.multipassTerrainEnabled&&a.varyings.add("depth","float");a.vertex.code.add(d.glsl`
  ...
  `);b.multipassTerrainEnabled&&(a.fragment.include(h.ReadLinearDepth),a.include(k.multipassTerrainTest,b));a.fragment.uniforms.add("size","vec2").add("color1","vec4").add("color2","vec4");a.fragment.include(g.ColorConversion);a.fragment.code.add(d.glsl`
    void main() {
