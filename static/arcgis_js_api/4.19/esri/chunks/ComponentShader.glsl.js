...
function(e,f,c,q,r,g,t,h,k,u,v,w,x,y,z,A,B,C,D,E,F,G,l,m,H){function n(a){const b=new q.ShaderBuilder;b.include(A.VertexPosition,a);b.include(B.VertexNormal,a);b.include(z.VertexColor,a);b.include(x.TextureCoordinateAttribute,a);b.include(w.ForwardLinearDepth,a);b.include(F.ComponentData,a);b.include(h.DiscardOrAdjustAlpha,a);b.include(r.Slice,a);b.include(H.ReadBaseColorTexture,a);b.include(G.VertexDiscardByOpacity,a);b.fragment.uniforms.add("view","mat4");if(1===a.pbrMode||2===a.pbrMode)b.include(y.PhysicallyBasedRenderingParameters,
a),b.include(C.ComputeNormalTexture,a);3===a.output&&1===a.componentData?b.vertex.code.add(c.glsl`
    ...
    `);const d=a.overlayEnabled&&0===a.output&&4===a.pbrMode;a.overlayEnabled&&(b.include(E.Overlay,a),1===a.viewingMode?b.vertex.code.add(c.glsl`
    ...
    void main() {
      ...
      if (externalColor.a < ${c.glsl.float(h.symbolAlphaCutoff)}) {
        // Discard this vertex
  ...
  `);7===a.output&&(b.fragment.include(g.ReadLinearDepth),a.multipassTerrainEnabled&&b.include(k.multipassTerrainTest,a),b.include(l.ComputeMaterialColor,a),b.fragment.code.add(c.glsl`
      void main() {
    ...
    `));0===a.output&&(b.fragment.include(g.ReadLinearDepth),a.multipassTerrainEnabled&&b.include(k.multipassTerrainTest,a),b.include(l.ComputeMaterialColor,a),b.include(m.ComputeShadingNormal,a),b.include(D.EvaluateSceneLighting,a),d&&(b.fragment.uniforms.add("ovInnerNormalTex","sampler2D"),b.fragment.uniforms.add("ovOuterNormalTex","sampler2D")),a.receiveShadows?(b.include(v.ReadShadowMap,a),b.fragment.code.add(c.glsl`
    ...
    `));if(1===a.output||3===a.output)b.include(u.OutputDepth,a),b.fragment.code.add(c.glsl`
      void main() {
        discardBySlice(vPositionWorldCameraRelative);
    ...
    `);2===a.output&&(b.include(m.ComputeShadingNormal,a),b.fragment.code.add(c.glsl`
      void main() {
        discardBySlice(vPositionWorldCameraRelative);
    ...
    `));4===a.output&&(b.include(t.OutputHighlight),b.fragment.code.add(c.glsl`
      void main() {
        discardBySlice(vPositionWorldCameraRelative);
    ...
    `));return b}const p={position:0,normal:1,normalCompressed:1,color:2,uv0:3,uvRegion:4,componentIndex:5};var I=Object.freeze({__proto__:null,attributeLocations:p,build:n});e.ComponentShader=I;e.attributeLocations=p;e.build=n});