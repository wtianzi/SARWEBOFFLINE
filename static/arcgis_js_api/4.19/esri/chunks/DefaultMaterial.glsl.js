...
function(e,c,n,p,f,g,q,d,r,h,t,u,v,w,x,y,z,A,B,C,D,E,F,G,H,I,J,K,k){function l(a){const b=new p.ShaderBuilder,L=b.vertex.code,m=b.fragment.code;b.include(K.HeaderComment,{name:"Default Material Shader",output:a.output});b.vertex.uniforms.add("proj","mat4").add("view","mat4").add("camPos","vec3").add("localOrigin","vec3");b.include(B.PositionAttribute);b.varyings.add("vpos","vec3");b.include(q.VisualVariables,a);b.include(w.InstancedDoublePrecision,a);b.include(r.VerticalOffset,a);if(0===a.output||
7===a.output)b.include(A.NormalAttribute,a),b.include(n.Transform,{linearDepth:!1}),0===a.normalType&&a.offsetBackfaces&&b.include(z.Offset),b.include(G.ComputeNormalTexture,a),b.include(E.VertexNormal,a),a.instancedColor&&b.attributes.add("instanceColor","vec4"),b.varyings.add("localvpos","vec3"),b.include(x.TextureCoordinateAttribute,a),b.include(u.ForwardLinearDepth,a),b.include(C.SymbolColor,a),b.include(D.VertexColor,a),b.vertex.uniforms.add("externalColor","vec4"),b.varyings.add("vcolorExt",
"vec4"),a.multipassTerrainEnabled&&b.varyings.add("depth","float"),L.add(c.glsl`
    ...
    `));0===a.output&&(b.include(f.Slice,a),b.include(I.EvaluateSceneLighting,a),b.include(H.EvaluateAmbientOcclusion,a),b.include(d.DiscardOrAdjustAlpha,a),a.receiveShadows&&b.include(t.ReadShadowMap,a),a.multipassTerrainEnabled&&(b.fragment.include(g.ReadLinearDepth),b.include(h.multipassTerrainTest,a)),b.fragment.uniforms.add("camPos","vec3").add("localOrigin","vec3").add("ambient","vec3").add("diffuse","vec3").add("opacity","float").add("layerOpacity","float"),a.hasColorTexture&&b.fragment.uniforms.add("tex",
"sampler2D"),b.include(y.PhysicallyBasedRenderingParameters,a),b.include(v.PhysicallyBasedRendering,a),b.fragment.include(k.MixExternalColor),b.include(J.Normals,a),m.add(c.glsl`
      void main() {
        discardBySlice(vpos);
        ${a.multipassTerrainEnabled?"terrainDepthTest(gl_FragCoord, depth);":""}
        ${a.hasColorTexture?c.glsl`
    ...
    `));b.include(F.DefaultMaterialAuxiliaryPasses,a);return b}var M=Object.freeze({__proto__:null,build:l});e.DefaultMaterialShader=M;e.build=l});