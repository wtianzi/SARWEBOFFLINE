...
define(["exports","../../../core/shaderModules/interfaces","../../../core/shaderLibrary/util/DoublePrecision.glsl"],function(f,c,g){function e(d,b){const a=d.vertex;a.uniforms.add("uDistanceFalloffFactor","float");a.code.add(c.glsl`
  ...
  `);a.uniforms.add("uComponentDataTex","sampler2D");a.uniforms.add("uComponentDataTexInvDim","vec2");d.attributes.add("componentIndex","float");a.constants.add("componentColorFieldOffset","float",0);a.constants.add("componentOtherFieldOffset","float",1);a.constants.add("componentFieldCount","float",2);a.constants.add("lineWidthFractionFactor","float",8);a.constants.add("extensionLengthOffset","float",128);a.constants.add("componentTexWidth","float",4096);a.code.add(c.glsl`
