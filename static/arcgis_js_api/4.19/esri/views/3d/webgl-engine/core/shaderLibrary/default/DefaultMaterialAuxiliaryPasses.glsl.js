...
a.include(h.TextureCoordinateAttribute,b),a.include(f.VisualVariables,b),a.include(p.OutputDepth,b),a.include(e.Slice,b),a.vertex.uniforms.add("cameraNearFar","vec2"),a.varyings.add("depth","float"),b.hasColorTexture&&a.fragment.uniforms.add("tex","sampler2D"),k.add(c.glsl`
      void main(void) {
        vpos = calculateVPos();
