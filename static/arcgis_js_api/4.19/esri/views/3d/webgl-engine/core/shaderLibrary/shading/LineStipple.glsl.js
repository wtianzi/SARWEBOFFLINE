...
//>>built
define(["exports","../../shaderModules/interfaces"],function(d,c){d.LineStipple=function(a,b){a.constants.add("stippleAlphaColorDiscard","float",.001);a.constants.add("stippleAlphaHighlightDiscard","float",.5);b.stippleEnabled?(a.vertex.uniforms.add("stipplePatternPixelSizeInv","float"),b.stippleUVMaxEnabled&&a.varyings.add("stipplePatternUvMax","float"),a.varyings.add("stipplePatternUv","float"),a.fragment.uniforms.add("stipplePatternTexture","sampler2D"),b.stippleOffColorEnabled&&a.fragment.uniforms.add("stippleOffColor",
